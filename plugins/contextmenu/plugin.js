...
var contextmenu = (function () {
  ...
  var $_bov5gkavjlnuea4g = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_d8ec4vaujlnuea4c.getContextMenu(editor);
  ...
  var $_1qgwkgayjlnuea4n = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_d8ec4vaujlnuea4c.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_1qgwkgayjlnuea4n.show(editor, $_bov5gkavjlnuea4g.getPos(editor, e), visibleState, menu);
    });
  };
  var $_1o8xm6atjlnuea48 = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_1o8xm6atjlnuea48.setup(editor, visibleState, menu);
    return $_527ga3asjlnuea46.get(visibleState);
  });
  function Plugin () {
  }
