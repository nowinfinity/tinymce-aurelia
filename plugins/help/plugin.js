...
var help = (function () {
  ...
  var $_5e7mztbmjlnuea8p = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = map($_5e7mztbmjlnuea8p.shortcuts, function (shortcut) {
  ...
  var $_8h15slbgjlnuea7s = { makeTab: makeTab };
  ...
  var $_35wj3ybojlnuea8w = { makeTab: makeTab$1 };
  ...
  var $_3v37njbujlnueaa5 = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_8h15slbgjlnuea7s.makeTab(),
          $_35wj3ybojlnuea8w.makeTab(editor)
        ],
        buttons: $_3v37njbujlnueaa5.makeRow(),
  ...
  var $_asucplbfjlnuea7p = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_asucplbfjlnuea7p.open(editor, pluginUrl));
  };
  var $_30bkmqbejlnuea7k = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_asucplbfjlnuea7p.open(editor, pluginUrl)
    });
  ...
  var $_cvqe8tbwjlnueaa8 = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_cvqe8tbwjlnueaa8.register(editor, pluginUrl);
    $_30bkmqbejlnuea7k.register(editor, pluginUrl);
