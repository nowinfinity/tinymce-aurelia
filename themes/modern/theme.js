...
var modern = (function () {
  ...
  var $_4jf431u0jlnueg1j = { addKeys: addKeys };
  ...
  var addContextualToolbars = function (editor) {
    ...
    var reposition = function (match, shouldShow) {
      ...
      var delta = $_9b37f0u4jlnueg1r.getUiContainerDelta(panel).getOr({
        x: 0,
        y: 0
      });
    ...
    var bindScrollEvent = function (panel) {
      if (!scrollContainer) {
        ...
        var uiContainer_1 = $_9b37f0u4jlnueg1r.getUiContainer(panel);
    ...
    var showContextToolbar = function (match) {
      ...
      panel = global$4.create({
        ...
        fixed: true,
        border: 1,
        items: $_8tgc5tu7jlnueg27.createToolbar(editor, match.toolbar.items),
        oncancel: function () {
          editor.focus();
        }
      });
      $_9b37f0u4jlnueg1r.setUiContainer(editor, panel);
  ...
  var $_c5y5yu1jlnueg1l = { addContextualToolbars: addContextualToolbars };
  ...
  var $_98zrrqu8jlnueg2a = { createMenuButtons: createMenuButtons };
  ...
  var resizeTo = function (editor, width, height) {
    ...
    $_3m8go0tzjlnueg1h.fireResizeEditor(editor);
  };
  var resizeBy = function (editor, dw, dh) {
    var elm = editor.getContentAreaContainer();
    resizeTo(editor, elm.clientWidth + dw, elm.clientHeight + dh);
  };
  var $_9mdujzubjlnueg2u = {
    resizeTo: resizeTo,
    resizeBy: resizeBy
  };
  ...
  var fireSkinLoaded$1 = function (editor) {
    var done = function () {
      ...
      $_3m8go0tzjlnueg1h.fireSkinLoaded(editor);
    };
    return function () {
      if (editor.initialized) {
        done();
  ...
  var $_84spkvuejlnueg31 = { fireSkinLoaded: fireSkinLoaded$1 };
  ...
  var editAreaContainer = function (editor) {
    return {
      ...
      items: [
        editArea('0'),
        $_fko4csucjlnueg2y.createSidebar(editor)
      ]
    };
  };
  var render = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM$2.styleSheetLoader.load(args.skinUiCss, $_84spkvuejlnueg31.fireSkinLoaded(editor));
    } else {
      $_84spkvuejlnueg31.fireSkinLoaded(editor)();
    }
      ...
      items: [
        {
          ...
          items: [
            hasMenubar(editor) === false ? null : {
              type: 'menubar',
              border: '0 0 1 0',
              items: $_98zrrqu8jlnueg2a.createMenuButtons(editor)
            },
            $_8tgc5tu7jlnueg27.createToolbars(editor, getToolbarSize(editor))
          ]
        },
        $_fko4csucjlnueg2y.hasSidebar(editor) ? editAreaContainer(editor) : editArea('1 0 0 0')
      ]
    });
    $_9b37f0u4jlnueg1r.setUiContainer(editor, panel);
      ...
      resizeHandleCtrl = {
        ...
        onResize: function (e) {
          if (getResize(editor) === 'both') {
            $_9mdujzubjlnueg2u.resizeTo(editor, startSize.width + e.deltaX, startSize.height + e.deltaY);
          } else {
            $_9mdujzubjlnueg2u.resizeTo(editor, null, startSize.height + e.deltaY);
          }
        }
      };
    }
    ...
    $_3m8go0tzjlnueg1h.fireBeforeRenderUI(editor);
    ...
    $_4jf431u0jlnueg1j.addKeys(editor, panel);
    $_c5y5yu1jlnueg1l.addContextualToolbars(editor);
    return {
      iframeContainer: panel.find('#iframe')[0].getEl(),
      editorContainer: panel.getEl()
    };
  };
  var $_bar1r6tvjlnueg18 = { render: render };
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_9b37f0u4jlnueg1r.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_9b37f0u4jlnueg1r.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_ljrhpukjlnueg4a = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_9b37f0u4jlnueg1r.getUiContainer(self$$1);
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_230axyuqjlnueg58.parseBox(settings.border);
      self$$1.paddingBox = $_230axyuqjlnueg58.parseBox(settings.padding);
      self$$1.marginBox = $_230axyuqjlnueg58.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_9b37f0u4jlnueg1r.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_230axyuqjlnueg58.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_230axyuqjlnueg58.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_230axyuqjlnueg58.measureBox(elm, 'margin');
  ...
  var render$1 = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM.styleSheetLoader.load(args.skinUiCss, $_84spkvuejlnueg31.fireSkinLoaded(editor));
    } else {
      $_84spkvuejlnueg31.fireSkinLoaded(editor)();
    }
    return {};
  };
  var $_cqs92ufjlnueg33 = { render: render$1 };
  ...
  var $_auqn5nv2jlnueg6l = { setup: setup };
  ...
  var renderUI = function (editor, theme, args) {
    ...
    $_auqn5nv2jlnueg6l.setup(editor, theme);
    return isInline(editor) ? $_cqs92ufjlnueg33.render(editor, theme, args) : $_bar1r6tvjlnueg18.render(editor, theme, args);
  };
  var $_c1wybjtrjlnueg0z = { renderUI: renderUI };

  var Tooltip = Control$1.extend({
    Mixins: [$_ljrhpukjlnueg4a],
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_9b37f0u4jlnueg1r.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_230axyuqjlnueg58.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_230axyuqjlnueg58.parseBox('0');
  ...
  var get = function (editor) {
    var renderUI = function (args) {
      return $_c1wybjtrjlnueg0z.renderUI(editor, this, args);
    };
    var resizeTo = function (w, h) {
      return $_9mdujzubjlnueg2u.resizeTo(editor, w, h);
    };
    var resizeBy = function (dw, dh) {
      return $_9mdujzubjlnueg2u.resizeBy(editor, dw, dh);
    };
  ...
  var isComment = function (element) {
    return type(element) === $_7no097w5jlnuegch.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_7no097w5jlnuegch.ELEMENT);
  var isText = isType$1($_7no097w5jlnuegch.TEXT);
  var isDocument = isType$1($_7no097w5jlnuegch.DOCUMENT);
  var $_a4qvphw4jlnuegcf = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_a4qvphw4jlnuegcf.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_9agbtewcjlnuege6 = { toArray: toArray };
  ...
  var $_bpnimcwfjlnuegf4 = { getOrDie: getOrDie };

  var node = function () {
    var f = $_bpnimcwfjlnuegf4.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_137p8pwljlnuegg1.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_137p8pwljlnuegg1.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_137p8pwljlnuegg1.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_fppwrowpjlnueghs = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_fppwrowpjlnueghs.browsers();
    var oses = $_fppwrowpjlnueghs.oses();
    var browser = $_2jnvsqwojlnueggn.detectBrowser(browsers, userAgent).fold($_quvf3wkjlnuegfu.unknown, $_quvf3wkjlnuegfu.nu);
    var os = $_2jnvsqwojlnueggn.detectOs(oses, userAgent).fold($_3y154wwmjlnuegg4.unknown, $_3y154wwmjlnuegg4.nu);
  ...
  var $_er6dliwjjlnuegfs = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_er6dliwjjlnuegfs.detect(userAgent);
  });
  var $_59o0j0wijlnuegfg = { detect: detect$3 };

  var ELEMENT = $_7no097w5jlnuegch.ELEMENT;
  var DOCUMENT = $_7no097w5jlnuegch.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_c7ny8iwejlnuegf2.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_59o0j0wijlnuegfg.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_5k0c1dwdjlnuege9 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_enujglwtjlnuegip.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_5k0c1dwdjlnuege9.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_5k0c1dwdjlnuege9.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_9agbtewcjlnuege6.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_9agbtewcjlnuege6.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_fkfcf1w2jlnuegc3.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_fbhhp3w6jlnuegcl.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_fbhhp3w6jlnuegcl.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_fbhhp3w6jlnuegcl.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_fbhhp3w6jlnuegcl.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_enujglwtjlnuegip.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_9qquzw1jlnuegbq.ancestors(scope, function (e) {
      return $_enujglwtjlnuegip.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_9qquzw1jlnuegbq.siblings(scope, function (e) {
      return $_enujglwtjlnuegip.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_9qquzw1jlnuegbq.children(scope, function (e) {
      return $_enujglwtjlnuegip.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_enujglwtjlnuegip.all(selector, scope);
  };
  var $_4pqm13w0jlnuegbn = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_4pqm13w0jlnuegbn.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_4gx8dbvxjlnueg9z = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_4gx8dbvxjlnueg9z.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_fkfcf1w2jlnuegc3.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_5k0c1dwdjlnuege9.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_enujglwtjlnuegip.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_7owvlcwzjlnuegk9.ancestor(scope, function (e) {
      return $_enujglwtjlnuegip.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_7owvlcwzjlnuegk9.sibling(scope, function (e) {
      return $_enujglwtjlnuegip.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_7owvlcwzjlnuegk9.child(scope, function (e) {
      return $_enujglwtjlnuegip.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_enujglwtjlnuegip.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_enujglwtjlnuegip.is, ancestor$1, scope, selector, isRoot);
  };
  var $_834aigwyjlnuegk5 = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_dkbqasx1jlnuegly = { register: register };
  ...
  var $_ji1cbx3jlnuegm5 = { register: register$1 };
  ...
  var $_gh2t6zx4jlnuegma = { register: register$2 };
  ...
  var $_na2iux5jlnuegmg = { register: register$3 };
  ...
  var $_aycwzcx6jlnuegmo = { register: register$4 };
  ...
  var $_f3omzyx7jlnuegmr = { register: register$5 };
  ...
  var $_82zs3dx8jlnuegmx = { register: register$6 };
  ...
  var $_dtahx0x9jlnuegn0 = { register: register$7 };
  ...
  var $_dcuozvxajlnuegn1 = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$8.container = $_834aigwyjlnuegk5.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup$1 = function (editor) {
    ...
    setupEnvironment();
    $_aycwzcx6jlnuegmo.register(editor);
    $_dkbqasx1jlnuegly.register(editor);
    $_82zs3dx8jlnuegmx.register(editor);
    $_dtahx0x9jlnuegn0.register(editor);
    $_gh2t6zx4jlnuegma.register(editor);
    $_ji1cbx3jlnuegm5.register(editor);
    $_na2iux5jlnuegmg.register(editor);
    $_dcuozvxajlnuegn1.register(editor);
    $_f3omzyx7jlnuegmr.register(editor);
  };
  var $_c4rye2wxjlnuegjk = { setup: setup$1 };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_7b0q80uxjlnueg5u,
      Control: Control$1,
      Factory: global$4,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_2qpvxluzjlnueg6a,
      Panel: Panel,
      Movable: $_ljrhpukjlnueg4a,
      Resizable: $_ekbg93v1jlnueg6i,
      ...
      FormatControls: $_c4rye2wxjlnuegjk,
  ...
  global.add('modern', function (editor) {
    $_c4rye2wxjlnuegjk.setup(editor);
    return $_1rzd6ttqjlnueg0w.get(editor);
  });
  function Theme () {
  }
