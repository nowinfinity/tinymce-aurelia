...
var inlite = (function () {
  ...
  var $_b95vn717xjlnuemeu = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_7ap8ky181jlnuemf5.fromClientRect(clientRect)) : null;
  };
  var $_6eyjee180jlnuemf2 = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_a37nt017zjlnuemey.result(predicateIds[i].id, $_6eyjee180jlnuemf2.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_a37nt017zjlnuemey.result(predicateIds[x].id, $_6eyjee180jlnuemf2.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_a37nt017zjlnuemey.result(id, $_6eyjee180jlnuemf2.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_a37nt017zjlnuemey.result(id, $_6eyjee180jlnuemf2.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_800gws18ajlnuemfm.isArray(value)) {
      return value;
    } else if ($_800gws18ajlnuemfm.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_800gws18ajlnuemfm.isBoolean(value)) {
  ...
  var $_e2dc1p189jlnuemfj = {
    getStringOr: getByTypeOr($_800gws18ajlnuemfm.isString),
    getBoolOr: getByTypeOr($_800gws18ajlnuemfm.isBoolean),
    getNumberOr: getByTypeOr($_800gws18ajlnuemfm.isNumber),
    getHandlerOr: getByTypeOr($_800gws18ajlnuemfm.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_800gws18ajlnuemfm.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_7ap8ky181jlnuemf5.toClientRect(targetRect),
        contentAreaRect: $_7ap8ky181jlnuemf5.toClientRect(contentAreaRect),
        panelRect: $_7ap8ky181jlnuemf5.toClientRect(panelRect)
      });
      return $_7ap8ky181jlnuemf5.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_e2dc1p189jlnuemfj.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_e2dc1p189jlnuemfj.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_e2dc1p189jlnuemfj.getHandlerOr(editor, 'inline_toolbar_position_handler', $_530fdc18bjlnuemfo.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_5w8qu3186jlnuemfe.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_flmrga187jlnuemfg.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_flmrga187jlnuemfg.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_c328un185jlnuemfc = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_b95vn717xjlnuemeu.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_aqtxip182jlnuemf8.fromContextToolbars(toolbars);
    result = $_a37nt017zjlnuemey.match(editor, [
      $_6uwr5s17yjlnuemew.element(elements[0], contextToolbarsPredicateIds),
      $_ec590r184jlnuemfa.textSelection('text'),
      $_ec590r184jlnuemfa.emptyTextBlock(elements, 'insert'),
      $_6uwr5s17yjlnuemew.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_a37nt017zjlnuemey.match(editor, [$_ec590r184jlnuemfa.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_c328un185jlnuemfc.load(editor, function () {
  ...
  var $_fwmiec17tjlnuemep = { renderUI: renderUI };
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_hgtsq18pjlnuemhq.parseBox(settings.border);
      self$$1.paddingBox = $_hgtsq18pjlnuemhq.parseBox(settings.padding);
      self$$1.marginBox = $_hgtsq18pjlnuemhq.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_71am4k18xjlnuemib.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_hgtsq18pjlnuemhq.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_hgtsq18pjlnuemhq.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_hgtsq18pjlnuemhq.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_74srl118wjlnuemi9.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_71am4k18xjlnuemib.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_71am4k18xjlnuemib.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_p9unv18yjlnuemim = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_71am4k18xjlnuemib.getUiContainer(self$$1);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_71am4k18xjlnuemib.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_hgtsq18pjlnuemhq.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_hgtsq18pjlnuemhq.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_fwmiec17tjlnuemep.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_1mg5y717sjlnuemem = { get: get };
  ...
  var $_ea0lym19gjlnuemkn = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_ea0lym19gjlnuemkn.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_8vtxz519ejlnuemkd = { blobToBase64: blobToBase64 };
  ...
  var $_foyb5c19kjlnuemkz = { pickFile: pickFile };
  ...
  var $_73pdkf19mjlnueml6 = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_9biywn19ojlnuemlb.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_9biywn19ojlnuemlb.resolve(dom, bookmark));
  };
  ...
  var $_48bf7d19njlnueml8 = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_73pdkf19mjlnueml6.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_48bf7d19njlnueml8.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_9mbuwm19ljlnueml3.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_foyb5c19kjlnuemkz.pickFile().then(function (files) {
          var blob = files[0];
          $_8vtxz519ejlnuemkd.blobToBase64(blob).then(function (base64) {
            $_9mbuwm19ljlnueml3.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_9mbuwm19ljlnueml3.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_36gwpv19djlnuemka = { addToEditor: addToEditor };
  ...
  var $_f369pd19sjlnuemlj = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_dgjdaf19ujlnuemlr.isAbsolute(href) && $_dgjdaf19ujlnuemlr.isDomainLike(href) ? askAboutPrefix(editor, href) : global$12.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_9mbuwm19ljlnueml3.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_9mbuwm19ljlnueml3.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_d1u0k319tjlnuemlp = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_800gws18ajlnuemfm.isArray(items)) {
      return items;
    } else if ($_800gws18ajlnuemfm.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_800gws18ajlnuemfm.isFunction(button)) {
            button = button();
          }
  ...
  var $_g3bkpb19vjlnuemlt = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_g3bkpb19vjlnuemlt.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_g3bkpb19vjlnuemlt.create(editor, 'text', $_flmrga187jlnuemfg.getTextSelectionToolbarItems(editor)),
        $_g3bkpb19vjlnuemlt.create(editor, 'insert', $_flmrga187jlnuemfg.getInsertToolbarItems(editor)),
        $_d1u0k319tjlnuemlp.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_flmrga187jlnuemfg.getPositionHandler(editor);
      contentAreaRect = $_6eyjee180jlnuemf2.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_530fdc18bjlnuemfo.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_530fdc18bjlnuemfo.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_f369pd19sjlnuemlj.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_530fdc18bjlnuemfo.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_6eyjee180jlnuemf2.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_530fdc18bjlnuemfo.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_530fdc18bjlnuemfo.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_5w8qu3186jlnuemfe.fireBeforeRenderUI(editor);
  ...
  var isComment = function (element) {
    return type(element) === $_ckf7nr1apjlnuemqj.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$2($_ckf7nr1apjlnuemqj.ELEMENT);
  var isText = isType$2($_ckf7nr1apjlnuemqj.TEXT);
  var isDocument = isType$2($_ckf7nr1apjlnuemqj.DOCUMENT);
  var $_g183j51aojlnuemqf = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_g183j51aojlnuemqf.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_7el3mx1awjlnuems9 = { toArray: toArray };

  var node = function () {
    var f = $_ea0lym19gjlnuemkn.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_7jz5ry1b2jlnuemtr.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_7jz5ry1b2jlnuemtr.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_7jz5ry1b2jlnuemtr.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_7jjhmt1b6jlnuemug = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_7jjhmt1b6jlnuemug.browsers();
    var oses = $_7jjhmt1b6jlnuemug.oses();
    var browser = $_bvza5s1b5jlnuemu8.detectBrowser(browsers, userAgent).fold($_btluiq1b1jlnuemtj.unknown, $_btluiq1b1jlnuemtj.nu);
    var os = $_bvza5s1b5jlnuemu8.detectOs(oses, userAgent).fold($_1mx1nh1b3jlnuemtt.unknown, $_1mx1nh1b3jlnuemtt.nu);
  ...
  var $_1dnggt1b0jlnuemth = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_1dnggt1b0jlnuemth.detect(userAgent);
  });
  var $_3pnw0e1azjlnuemt5 = { detect: detect$3 };

  var ELEMENT = $_ckf7nr1apjlnuemqj.ELEMENT;
  var DOCUMENT = $_ckf7nr1apjlnuemqj.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_8i1ip91ayjlnuemt3.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_3pnw0e1azjlnuemt5.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_6y9ex01axjlnuemsc = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_8i9ccc1bajlnuemv4.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_6y9ex01axjlnuemsc.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_6y9ex01axjlnuemsc.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_7el3mx1awjlnuems9.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_7el3mx1awjlnuems9.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_47kz981amjlnuemq4.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_63t4sw1aqjlnuemqo.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_63t4sw1aqjlnuemqo.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_63t4sw1aqjlnuemqo.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_63t4sw1aqjlnuemqo.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_8i9ccc1bajlnuemv4.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_ar31gq1aljlnuempx.ancestors(scope, function (e) {
      return $_8i9ccc1bajlnuemv4.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_ar31gq1aljlnuempx.siblings(scope, function (e) {
      return $_8i9ccc1bajlnuemv4.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_ar31gq1aljlnuempx.children(scope, function (e) {
      return $_8i9ccc1bajlnuemv4.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_8i9ccc1bajlnuemv4.all(selector, scope);
  };
  var $_fiosfl1akjlnuempu = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_fiosfl1akjlnuempu.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_12ybv71ahjlnuemof = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_12ybv71ahjlnuemof.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_47kz981amjlnuemq4.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_6y9ex01axjlnuemsc.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_8i9ccc1bajlnuemv4.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_6am7jx1bgjlnuemwi.ancestor(scope, function (e) {
      return $_8i9ccc1bajlnuemv4.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_6am7jx1bgjlnuemwi.sibling(scope, function (e) {
      return $_8i9ccc1bajlnuemv4.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_6am7jx1bgjlnuemwi.child(scope, function (e) {
      return $_8i9ccc1bajlnuemv4.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_8i9ccc1bajlnuemv4.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_8i9ccc1bajlnuemv4.is, ancestor$1, scope, selector, isRoot);
  };
  var $_6wanoe1bfjlnuemwe = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_fqkfs61bijlnuemy3 = { register: register };
  ...
  var $_44c58n1bkjlnuemy9 = { register: register$1 };
  ...
  var $_eu360h1bljlnuemye = { register: register$2 };
  ...
  var $_1zuzvd1bmjlnuemyl = { register: register$3 };
  ...
  var $_clsopm1bnjlnuemyr = { register: register$4 };
  ...
  var $_1hkiy81bojlnuemyw = { register: register$5 };
  ...
  var $_dy12qe1bpjlnuemz6 = { register: register$6 };
  ...
  var $_8wloub1bqjlnuemz9 = { register: register$7 };
  ...
  var $_4tzbd71brjlnuemzb = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_6wanoe1bfjlnuemwe.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_clsopm1bnjlnuemyr.register(editor);
    $_fqkfs61bijlnuemy3.register(editor);
    $_dy12qe1bpjlnuemz6.register(editor);
    $_8wloub1bqjlnuemz9.register(editor);
    $_eu360h1bljlnuemye.register(editor);
    $_44c58n1bkjlnuemy9.register(editor);
    $_1zuzvd1bmjlnuemyl.register(editor);
    $_4tzbd71brjlnuemzb.register(editor);
    $_1hkiy81bojlnuemyw.register(editor);
  };
  var $_2tvz201bejlnuemw1 = { setup: setup };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_74srl118wjlnuemi9,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_8zp38n19ajlnuemjz,
      Panel: Panel,
      Movable: $_p9unv18yjlnuemim,
      Resizable: $_8ej1p019bjlnuemk2,
      ...
      FormatControls: $_2tvz201bejlnuemw1,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_2tvz201bejlnuemw1.setup(editor);
    $_36gwpv19djlnuemka.addToEditor(editor, panel);
    return $_1mg5y717sjlnuemem.get(editor, panel);
  });
  function Theme () {
  }
