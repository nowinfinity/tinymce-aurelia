...
var mobile = (function () {
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_34eko0y8jlnueh8q.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_34eko0y8jlnueh8q.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_34eko0y8jlnueh8q.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_4cbrq8ydjlnueh9k = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_4cbrq8ydjlnueh9k.browsers();
    var oses = $_4cbrq8ydjlnueh9k.oses();
    var browser = $_chiv0wybjlnueh95.detectBrowser(browsers, userAgent).fold($_g7o6sey7jlnueh8k.unknown, $_g7o6sey7jlnueh8k.nu);
    var os = $_chiv0wybjlnueh95.detectOs(oses, userAgent).fold($_296guwy9jlnueh8s.unknown, $_296guwy9jlnueh8s.nu);
  ...
  var $_82supwy6jlnueh8h = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_82supwy6jlnueh8h.detect(userAgent);
  });
  var $_c4pfxvy3jlnueh7s = { detect: detect$3 };
  ...
  var tap = alloy.tap;
  var tapOrClick = $_c4pfxvy3jlnueh7s.detect().deviceType.isTouch() ? alloy.tap : click;
  ...
  var isComment = function (element) {
    return type(element) === $_8auvy2yljlnuehc7.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_8auvy2yljlnuehc7.ELEMENT);
  var isText = isType$1($_8auvy2yljlnuehc7.TEXT);
  var isDocument = isType$1($_8auvy2yljlnuehc7.DOCUMENT);
  var $_exqx3lykjlnuehc5 = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_exqx3lykjlnuehc5.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_6ap5x5ysjlnuehdk = { toArray: toArray };
  ...
  var $_4brph3yvjlnuehec = { getOrDie: getOrDie };

  var node = function () {
    var f = $_4brph3yvjlnuehec.getOrDie('Node');
    return f;
  };
  ...
  var $_43te9zyujlnuehe9 = {
    documentPositionPreceding: documentPositionPreceding,
    documentPositionContainedBy: documentPositionContainedBy
  };

  var ELEMENT = $_8auvy2yljlnuehc7.ELEMENT;
  var DOCUMENT = $_8auvy2yljlnuehc7.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_43te9zyujlnuehe9.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_c4pfxvy3jlnueh7s.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_1163wgytjlnuehdl = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_19vj3yyyjlnuehep.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_1163wgytjlnuehdl.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_1163wgytjlnuehdl.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_6ap5x5ysjlnuehdk.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_6ap5x5ysjlnuehdk.toArray(element, nextSibling);
  };
  ...
  var before = function (marker, element) {
    var parent = $_8ewcplynjlnuehce.parent(marker);
    parent.each(function (v) {
      v.dom().insertBefore(element.dom(), marker.dom());
    });
  };
  var after = function (marker, element) {
    var sibling = $_8ewcplynjlnuehce.nextSibling(marker);
  ...
  var prepend = function (parent, element) {
    var firstChild = $_8ewcplynjlnuehce.firstChild(parent);
  ...
  var appendAt = function (parent, element, index) {
    $_8ewcplynjlnuehce.child(parent, index).fold(function () {
      append(parent, element);
    }, function (v) {
      before(v, element);
    });
  ...
  var before$1 = function (marker, elements) {
    each$1(elements, function (x) {
      $_5naldxymjlnuehcb.before(marker, x);
    });
  };
  var after$1 = function (marker, elements) {
    each$1(elements, function (x, i) {
      var e = i === 0 ? marker : elements[i - 1];
      $_5naldxymjlnuehcb.after(e, x);
    });
  };
  var prepend$1 = function (parent, elements) {
    each$1(elements.slice().reverse(), function (x) {
      $_5naldxymjlnuehcb.prepend(parent, x);
    });
  };
  var append$1 = function (parent, elements) {
    each$1(elements, function (x) {
      $_5naldxymjlnuehcb.append(parent, x);
    });
  };
  var $_24dkeiz0jlnuehfb = {
    before: before$1,
    after: after$1,
    prepend: prepend$1,
    append: append$1
  ...
  var empty = function (element) {
    ...
    each$1($_8ewcplynjlnuehce.children(element), function (rogue) {
      remove(rogue);
    });
  };
  ...
  var unwrap = function (wrapper) {
    var children = $_8ewcplynjlnuehce.children(wrapper);
    if (children.length > 0)
      $_24dkeiz0jlnuehfb.before(wrapper, children);
    remove(wrapper);
  };
  var $_fdmzyyyzjlnuehf3 = {
    empty: empty,
    remove: remove,
    unwrap: unwrap
  };
  ...
  var attach = function (parent, child) {
    attachWith(parent, child, $_5naldxymjlnuehcb.append);
  };
  var attachWith = function (parent, child, insertion) {
    parent.getSystem().addToWorld(child);
    insertion(parent.element(), child.element());
    if ($_7usjeyyijlnuehbd.inBody(parent.element())) {
      fireAttaching(child);
    }
  ...
  var doDetach = function (component) {
    ...
    $_fdmzyyyzjlnuehf3.remove(component.element());
    component.getSystem().removeFromWorld(component);
  };
  var detach = function (component) {
    var parent = $_8ewcplynjlnuehce.parent(component.element()).bind(function (p) {
  ...
  var detachChildren = function (component) {
    ...
    $_fdmzyyyzjlnuehf3.empty(component.element());
    component.syncComponents();
  };
  var attachSystem = function (element, guiSystem) {
    $_5naldxymjlnuehcb.append(element, guiSystem.element());
    var children = $_8ewcplynjlnuehce.children(guiSystem.element());
  ...
  var json = function () {
    return $_4brph3yvjlnuehec.getOrDie('JSON');
  };
  ...
  var $_al0vefzhjlnuehlm = {
    parse: parse,
    stringify: stringify
  };

  var formatObj = function (input) {
    return isObject(input) && keys(input).length > 100 ? ' removed due to size' : $_al0vefzhjlnuehlm.stringify(input, null, 2);
  };
  ...
  var isSource = function (component, simulatedEvent) {
    return $_1163wgytjlnuehdl.eq(component.element(), simulatedEvent.event().target());
  };

  var nu$4 = function (parts) {
    if (!hasKey$1(parts, 'can') && !hasKey$1(parts, 'abort') && !hasKey$1(parts, 'run')) {
      throw new Error('EventHandler defined by: ' + $_al0vefzhjlnuehlm.stringify(parts, null, 2) + ' does not have can, abort, or run!');
    }
  ...
  var defToStr = function (defn) {
    ...
    return $_al0vefzhjlnuehlm.stringify(raw, null, 2);
  };
  var defToRaw = function (defn) {
    return {
      ...
      defChildren: defn.defChildren().fold(function () {
        ...
        return $_al0vefzhjlnuehlm.stringify(d, null, 2);
      }),
  ...
  var transfer = function (source, destination, attrs) {
    if (!$_exqx3lykjlnuehc5.isElement(source) || !$_exqx3lykjlnuehc5.isElement(destination))
      return;
    each$1(attrs, function (attr) {
      transferOne(source, destination, attr);
    });
  };
  var $_a7p349zwjlnuehs3 = {
    clone: clone,
    set: set,
    setAll: setAll,
    get: get,
  ...
  var read$1 = function (element, attr) {
    var value = $_a7p349zwjlnuehs3.get(element, attr);
    return value === undefined || value === '' ? [] : value.split(' ');
  };
  var add = function (element, attr, id) {
    var old = read$1(element, attr);
    var nu = old.concat([id]);
    $_a7p349zwjlnuehs3.set(element, attr, nu.join(' '));
    return true;
  };
  var remove$2 = function (element, attr, id) {
    ...
    if (nu.length > 0)
      ...
      $_a7p349zwjlnuehs3.remove(element, attr);
    return false;
  };
  var $_btjxr1zyjlnuehsv = {
    read: read$1,
    add: add,
    remove: remove$2
  };
  ...
  var get$1 = function (element) {
    return $_btjxr1zyjlnuehsv.read(element, 'class');
  };
  var add$1 = function (element, clazz) {
    return $_btjxr1zyjlnuehsv.add(element, 'class', clazz);
  };
  var remove$3 = function (element, clazz) {
    return $_btjxr1zyjlnuehsv.remove(element, 'class', clazz);
  };
  ...
  var add$2 = function (element, clazz) {
    if ($_9skks0zxjlnuehsp.supports(element))
      element.dom().classList.add(clazz);
    else
      $_9skks0zxjlnuehsp.add(element, clazz);
  };
  var cleanClass = function (element) {
    var classList = $_9skks0zxjlnuehsp.supports(element) ? element.dom().classList : $_9skks0zxjlnuehsp.get(element);
    if (classList.length === 0) {
      $_a7p349zwjlnuehs3.remove(element, 'class');
    }
  };
  var remove$4 = function (element, clazz) {
    if ($_9skks0zxjlnuehsp.supports(element)) {
      ...
      $_9skks0zxjlnuehsp.remove(element, clazz);
    cleanClass(element);
  };
  var toggle$1 = function (element, clazz) {
    return $_9skks0zxjlnuehsp.supports(element) ? element.dom().classList.toggle(clazz) : $_9skks0zxjlnuehsp.toggle(element, clazz);
  };
  var toggler = function (element, clazz) {
    var hasClasslist = $_9skks0zxjlnuehsp.supports(element);
    var classList = element.dom().classList;
    var off = function () {
      if (hasClasslist)
        classList.remove(clazz);
  ...
  var has$1 = function (element, clazz) {
    return $_9skks0zxjlnuehsp.supports(element) && element.dom().classList.contains(clazz);
  };
  var $_1tj8hmzujlnuehrz = {
    add: add$2,
    remove: remove$4,
    toggle: toggle$1,
    toggler: toggler,
  ...
  var swap = function (element, addCls, removeCls) {
    $_1tj8hmzujlnuehrz.remove(element, removeCls);
    $_1tj8hmzujlnuehrz.add(element, addCls);
  };
  ...
  var clear = function (component, swapConfig, swapState) {
    $_1tj8hmzujlnuehrz.remove(component.element(), swapConfig.alpha());
    $_1tj8hmzujlnuehrz.remove(component.element(), swapConfig.omega());
  };
  var isAlpha = function (component, swapConfig, swapState) {
    return $_1tj8hmzujlnuehrz.has(component.element(), swapConfig.alpha());
  };
  var isOmega = function (component, swapConfig, swapState) {
    return $_1tj8hmzujlnuehrz.has(component.element(), swapConfig.omega());
  };
  ...
  var first$1 = function (predicate) {
    return descendant($_7usjeyyijlnuehbd.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_1163wgytjlnuehdl.eq(scope, x) && predicate(x);
    });
  };
  ...
  var any$1 = function (predicate) {
    return $_6b680c103jlnuehtq.first(predicate).isSome();
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    return $_6b680c103jlnuehtq.ancestor(scope, predicate, isRoot).isSome();
  };
  var closest$1 = function (scope, predicate, isRoot) {
    return $_6b680c103jlnuehtq.closest(scope, predicate, isRoot).isSome();
  };
  var sibling$1 = function (scope, predicate) {
    return $_6b680c103jlnuehtq.sibling(scope, predicate).isSome();
  };
  var child$2 = function (scope, predicate) {
    return $_6b680c103jlnuehtq.child(scope, predicate).isSome();
  };
  var descendant$1 = function (scope, predicate) {
    return $_6b680c103jlnuehtq.descendant(scope, predicate).isSome();
  };
  var $_2ugf89102jlnuehto = {
    any: any$1,
    ancestor: ancestor$1,
    closest: closest$1,
    sibling: sibling$1,
  ...
  var hasFocus = function (element) {
    var doc = $_8ewcplynjlnuehce.owner(element).dom();
  ...
  var focusInside = function (element) {
    var doc = $_8ewcplynjlnuehce.owner(element);
    var inside = active(doc).filter(function (a) {
      return $_2ugf89102jlnuehto.closest(a, curry($_1163wgytjlnuehdl.eq, element));
    });
  ...
  var search = function (element) {
    return active($_8ewcplynjlnuehce.owner(element)).filter(function (e) {
      return element.dom().contains(e.dom());
    });
  };
  var $_dq8hw101jlnuehtb = {
    hasFocus: hasFocus,
    focus: focus$2,
    blur: blur$$1,
    active: active,
  ...
  var $_h8tr1107jlnuehus = { openLink: openLink };
  ...
  var fromHtml$1 = function (html, scope) {
    ...
    var div = doc.createElement('div');
    div.innerHTML = html;
    return $_8ewcplynjlnuehce.children(Element$$1.fromDom(div));
  };
  ...
  var set$1 = function (element, content) {
    var owner = $_8ewcplynjlnuehce.owner(element);
    var docDom = owner.dom();
    var fragment = Element$$1.fromDom(docDom.createDocumentFragment());
    var contentElements = $_e8racn10gjlnuehx6.fromHtml(content, docDom);
    $_24dkeiz0jlnuehfb.append(fragment, contentElements);
    $_fdmzyyyzjlnuehf3.empty(element);
    $_5naldxymjlnuehcb.append(element, fragment);
  };
  var getOuter = function (element) {
    var container = Element$$1.fromTag('div');
    var clone = Element$$1.fromDom(element.dom().cloneNode(true));
    $_5naldxymjlnuehcb.append(container, clone);
    return get$2(container);
  };
  var $_9yuaun10fjlnuehx4 = {
    get: get$2,
    set: set$1,
    getOuter: getOuter
  };
  ...
  var shallowAs = function (original, tag) {
    ...
    var attributes = $_a7p349zwjlnuehs3.clone(original);
    $_a7p349zwjlnuehs3.setAll(nu, attributes);
    return nu;
  };
  var copy = function (original, tag) {
    var nu = shallowAs(original, tag);
    var cloneChildren = $_8ewcplynjlnuehce.children(deep$1(original));
    $_24dkeiz0jlnuehfb.append(nu, cloneChildren);
    return nu;
  };
  var mutate = function (original, tag) {
    var nu = shallowAs(original, tag);
    $_5naldxymjlnuehcb.before(original, nu);
    var children = $_8ewcplynjlnuehce.children(original);
    $_24dkeiz0jlnuehfb.append(nu, children);
    $_fdmzyyyzjlnuehf3.remove(original);
    return nu;
  };
  var $_3jvxjt10hjlnuehxf = {
    shallow: shallow$1,
    shallowAs: shallowAs,
    deep: deep$1,
    copy: copy,
  ...
  var getHtml = function (element) {
    var clone = $_3jvxjt10hjlnuehxf.shallow(element);
    return $_9yuaun10fjlnuehx4.getOuter(clone);
  };
  ...
  var toggle$2 = function (component, toggleConfig, toggleState) {
    $_1tj8hmzujlnuehrz.toggle(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var on = function (component, toggleConfig, toggleState) {
    $_1tj8hmzujlnuehrz.add(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var off = function (component, toggleConfig, toggleState) {
    $_1tj8hmzujlnuehrz.remove(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var isOn = function (component, toggleConfig) {
    return $_1tj8hmzujlnuehrz.has(component.element(), toggleConfig.toggleClass());
  };
  ...
  var updatePressed = function (component, ariaInfo, status) {
    $_a7p349zwjlnuehs3.set(component.element(), 'aria-pressed', status);
    if (ariaInfo.syncWithExpanded()) {
      updateExpanded(component, ariaInfo, status);
    }
  };
  var updateSelected = function (component, ariaInfo, status) {
    $_a7p349zwjlnuehs3.set(component.element(), 'aria-selected', status);
  };
  var updateChecked = function (component, ariaInfo, status) {
    $_a7p349zwjlnuehs3.set(component.element(), 'aria-checked', status);
  };
  var updateExpanded = function (component, ariaInfo, status) {
    $_a7p349zwjlnuehs3.set(component.element(), 'aria-expanded', status);
  };
  ...
  var format = function (command, update) {
    return Receiving.config({
      channels: wrap$2($_djvm81109jlnuehv2.formatChanged(), {
  ...
  var orientation = function (onReceive) {
    return Receiving.config({ channels: wrap$2($_djvm81109jlnuehv2.orientationChanged(), { onReceive: onReceive }) });
  };
  ...
  var events$2 = function (optAction) {
    ...
    var pointerEvents = $_c4pfxvy3jlnueh7s.detect().deviceType.isTouch() ? [run(tap(), onClick)] : [
      run(click(), onClick),
  ...
  var focus$3 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_dq8hw101jlnuehtb.focus(component.element());
      focusConfig.onFocus()(component);
    }
  };
  var blur$1 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_dq8hw101jlnuehtb.blur(component.element());
    }
  };
  var isFocused = function (component) {
    return $_dq8hw101jlnuehtb.hasFocus(component.element());
  };
  ...
  var $_5339t4117jlnuei89 = { isSupported: isSupported };
  ...
  var internalSet = function (dom, property, value) {
    ...
    if ($_5339t4117jlnuei89.isSupported(dom))
  ...
  var get$3 = function (element, property) {
    ...
    var v = r === '' && !$_7usjeyyijlnuehbd.inBody(element) ? getUnsafeProperty(dom, property) : r;
    return v === null ? undefined : v;
  };
  var getUnsafeProperty = function (dom, property) {
    return $_5339t4117jlnuei89.isSupported(dom) ? dom.style.getPropertyValue(property) : '';
  };
  ...
  var remove$5 = function (element, property) {
    ...
    if ($_a7p349zwjlnuehs3.has(element, 'style') && trim($_a7p349zwjlnuehs3.get(element, 'style')) === '') {
      $_a7p349zwjlnuehs3.remove(element, 'style');
    }
  };
  var preserve = function (element, f) {
    var oldStyles = $_a7p349zwjlnuehs3.get(element, 'style');
    var result = f(element);
    var restore = oldStyles === undefined ? $_a7p349zwjlnuehs3.remove : $_a7p349zwjlnuehs3.set;
  ...
  var copy$1 = function (source, target) {
    ...
    if ($_5339t4117jlnuei89.isSupported(sourceDom) && $_5339t4117jlnuei89.isSupported(targetDom)) {
  ...
  function Dimension (name, getOffset) {
    ...
    var get = function (element) {
      ...
      if (r <= 0 || r === null) {
        var css = $_av4glr116jlnuei7e.get(element, name);
    ...
    var aggregate = function (element, properties) {
      return foldl(properties, function (acc, property) {
        var val = $_av4glr116jlnuei7e.get(element, property);
  ...
  var api = Dimension('height', function (element) {
    var dom = element.dom();
    return $_7usjeyyijlnuehbd.inBody(element) ? dom.getBoundingClientRect().height : dom.offsetHeight;
  });
  ...
  var setMax = function (element, value) {
    ...
    $_av4glr116jlnuei7e.set(element, 'max-height', absMax + 'px');
  };
  var $_2lw4bu115jlnuei7b = {
    set: set$3,
    get: get$4,
    getOuter: getOuter$1,
    setMax: setMax
  ...
  var all$2 = function (predicate) {
    return descendants($_7usjeyyijlnuehbd.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_8ewcplynjlnuehce.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_8ewcplynjlnuehce.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_8ewcplynjlnuehce.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each$1($_8ewcplynjlnuehce.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$3 = function (selector) {
    return $_19vj3yyyjlnuehep.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_1sfndc11ajlnuei8q.ancestors(scope, function (e) {
      return $_19vj3yyyjlnuehep.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_1sfndc11ajlnuei8q.siblings(scope, function (e) {
      return $_19vj3yyyjlnuehep.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_1sfndc11ajlnuei8q.children(scope, function (e) {
      return $_19vj3yyyjlnuehep.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_19vj3yyyjlnuehep.all(selector, scope);
  };
  var $_ff9i66119jlnuei8o = {
    all: all$3,
  ...
  var first$2 = function (selector) {
    return $_19vj3yyyjlnuehep.one(selector);
  };
  var ancestor$2 = function (scope, selector, isRoot) {
    return $_6b680c103jlnuehtq.ancestor(scope, function (e) {
      return $_19vj3yyyjlnuehep.is(e, selector);
    }, isRoot);
  };
  var sibling$2 = function (scope, selector) {
    return $_6b680c103jlnuehtq.sibling(scope, function (e) {
      return $_19vj3yyyjlnuehep.is(e, selector);
    });
  };
  var child$3 = function (scope, selector) {
    return $_6b680c103jlnuehtq.child(scope, function (e) {
      return $_19vj3yyyjlnuehep.is(e, selector);
    });
  };
  var descendant$2 = function (scope, selector) {
    return $_19vj3yyyjlnuehep.one(selector, scope);
  };
  var closest$2 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_19vj3yyyjlnuehep.is, ancestor$2, scope, selector, isRoot);
  };
  var $_4cszdu11bjlnuei8x = {
    first: first$2,
    ancestor: ancestor$2,
    sibling: sibling$2,
    child: child$3,
  ...
  var dehighlightAll = function (component, hConfig, hState) {
    var highlighted = $_ff9i66119jlnuei8o.descendants(component.element(), '.' + hConfig.highlightClass());
    each$1(highlighted, function (h) {
      $_1tj8hmzujlnuehrz.remove(h, hConfig.highlightClass());
  ...
  var dehighlight = function (component, hConfig, hState, target) {
    ...
    $_1tj8hmzujlnuehrz.remove(target.element(), hConfig.highlightClass());
    if (wasHighlighted) {
      hConfig.onDehighlight()(component, target);
    }
  };
  var highlight = function (component, hConfig, hState, target) {
    ...
    $_1tj8hmzujlnuehrz.add(target.element(), hConfig.highlightClass());
    if (!wasHighlighted) {
  ...
  var highlightBy = function (component, hConfig, hState, predicate) {
    var items = $_ff9i66119jlnuei8o.descendants(component.element(), '.' + hConfig.itemClass());
  ...
  var isHighlighted = function (component, hConfig, hState, queryTarget) {
    return $_1tj8hmzujlnuehrz.has(queryTarget.element(), hConfig.highlightClass());
  };
  var getHighlighted = function (component, hConfig, hState) {
    return $_4cszdu11bjlnuei8x.descendant(component.element(), '.' + hConfig.highlightClass()).bind(function (e) {
  ...
  var getFirst = function (component, hConfig, hState) {
    return $_4cszdu11bjlnuei8x.descendant(component.element(), '.' + hConfig.itemClass()).bind(function (e) {
      return component.getSystem().getByDom(e).toOption();
    });
  };
  ...
  var getDelta = function (component, hConfig, hState, delta) {
    ...
    var current = findIndex(items, function (item) {
      return $_1tj8hmzujlnuehrz.has(item, hConfig.highlightClass());
    });
  ...
  var dom = function () {
    var get = function (component) {
      return $_dq8hw101jlnuehtb.search(component.element());
    };
  ...
  var create$2 = function (cyclicField) {
    ...
    var isVisible = function (tabbingConfig, element) {
      var target = tabbingConfig.visibilitySelector().bind(function (sel) {
        return $_4cszdu11bjlnuei8x.closest(element, sel);
      }).getOr(element);
      return $_2lw4bu115jlnuei7b.get(target) > 0;
    };
    var findInitial = function (component, tabbingConfig) {
      var tabstops = $_ff9i66119jlnuei8o.descendants(component.element(), tabbingConfig.selector());
    ...
    var findCurrent = function (component, tabbingConfig) {
      return tabbingConfig.focusManager().get(component).bind(function (elem) {
        return $_4cszdu11bjlnuei8x.closest(elem, tabbingConfig.selector());
      });
    };
    ...
    var go = function (component, simulatedEvent, tabbingConfig, cycle) {
      ...
      return findCurrent(component, tabbingConfig).bind(function (tabstop) {
        var optStopIndex = findIndex(tabstops, curry($_1163wgytjlnuehdl.eq, tabstop));
  ...
  var inside = function (target) {
    return $_exqx3lykjlnuehc5.name(target) === 'input' && $_a7p349zwjlnuehs3.get(target, 'type') !== 'radio' || $_exqx3lykjlnuehc5.name(target) === 'textarea';
  };
  ...
  var getDirection = function (element) {
    return $_av4glr116jlnuei7e.get(element, 'direction') === 'rtl' ? 'rtl' : 'ltr';
  };
  var $_62tc4g11tjlnueify = {
  ...
  var west = function (moveLeft, moveRight) {
    var movement = $_62tc4g11tjlnueify.onDirection(moveLeft, moveRight);
    return useH(movement);
  };
  var east = function (moveLeft, moveRight) {
    var movement = $_62tc4g11tjlnueify.onDirection(moveRight, moveLeft);
    return useH(movement);
  };
  ...
  var visibilityToggler = function (element, property, hiddenValue, visibleValue) {
    var initial = $_av4glr116jlnuei7e.get(element, property);
    if (initial === undefined)
      initial = '';
    var value = initial === hiddenValue ? visibleValue : hiddenValue;
    var off = curry($_av4glr116jlnuei7e.set, element, property, initial);
    var on = curry($_av4glr116jlnuei7e.set, element, property, value);
  ...
  var locateVisible = function (container, current, selector) {
    var filter$$1 = $_2xf0vc11vjlnueigx.isVisible;
    return locateIn(container, current, selector, filter$$1);
  };
  var locateIn = function (container, current, selector, filter$$1) {
    var predicate = curry($_1163wgytjlnuehdl.eq, current);
    var candidates = $_ff9i66119jlnuei8o.descendants(container, selector);
    var visible = filter(candidates, $_2xf0vc11vjlnueigx.isVisible);
    return locate(visible, predicate);
  };
  var findIndex$2 = function (elements, target) {
    return findIndex(elements, function (elem) {
      return $_1163wgytjlnuehdl.eq(target, elem);
    });
  };
  ...
  var focusIn = function (component, gridConfig, gridState) {
    $_4cszdu11bjlnuei8x.descendant(component.element(), gridConfig.selector()).each(function (first) {
      gridConfig.focusManager().set(component, first);
    });
  };
  var findCurrent = function (component, gridConfig) {
    return gridConfig.focusManager().get(component).bind(function (elem) {
      return $_4cszdu11bjlnuei8x.closest(elem, gridConfig.selector());
    });
  };
  ...
  var findCurrent$1 = function (component, flowConfig) {
    return flowConfig.focusManager().get(component).bind(function (elem) {
      return $_4cszdu11bjlnuei8x.closest(elem, flowConfig.selector());
    });
  };
  ...
  var focusIn$1 = function (component, flowConfig) {
    flowConfig.getInitial()(component).or($_4cszdu11bjlnuei8x.descendant(component.element(), flowConfig.selector())).each(function (first) {
  ...
  var focusIn$2 = function (component, matrixConfig) {
    var focused = matrixConfig.previousSelector()(component).orThunk(function () {
      ...
      return $_4cszdu11bjlnuei8x.descendant(component.element(), selectors.cell());
    });
  ...
  var execute$4 = function (component, simulatedEvent, matrixConfig) {
    return $_dq8hw101jlnuehtb.search(component.element()).bind(function (focused) {
      return matrixConfig.execute()(component, simulatedEvent, focused);
    });
  };
  var toMatrix = function (rows, matrixConfig) {
    return map$1(rows, function (row) {
      return $_ff9i66119jlnuei8o.descendants(row, matrixConfig.selectors().cell());
    });
  };
  var doMove$2 = function (ifCycle, ifMove) {
    return function (element, focused, matrixConfig) {
      var move$$1 = matrixConfig.cycles() ? ifCycle : ifMove;
      return $_4cszdu11bjlnuei8x.closest(focused, matrixConfig.selectors().row()).bind(function (inRow) {
        var cellsInRow = $_ff9i66119jlnuei8o.descendants(inRow, matrixConfig.selectors().cell());
        return findIndex$2(cellsInRow, focused).bind(function (colIndex) {
          var allRows = $_ff9i66119jlnuei8o.descendants(element, matrixConfig.selectors().row());
  ...
  var focusIn$3 = function (component, menuConfig) {
    $_4cszdu11bjlnuei8x.descendant(component.element(), menuConfig.selector()).each(function (first) {
  ...
  var subPlaceholder = function (owner, detail, compSpec, placeholders) {
    ...
    return readOptFrom$1(placeholders, compSpec.name).fold(function () {
      throw new Error('Unknown placeholder component: ' + compSpec.name + '\nKnown: [' + keys(placeholders) + ']\nNamespace: ' + owner.getOr('none') + '\nSpec: ' + $_al0vefzhjlnuehlm.stringify(compSpec, null, 2));
    }, function (newSpec) {
  ...
  var substitutePlaces = function (owner, detail, components, placeholders) {
    ...
    each(ps, function (p) {
      if (p.used() === false && p.required()) {
        throw new Error('Placeholder: ' + p.name() + ' was not found in components list\nNamespace: ' + owner.getOr('none') + '\nComponents: ' + $_al0vefzhjlnuehlm.stringify(detail.components(), null, 2));
      }
    });
    return outcome;
  };
  ...
  var write = function (label, elem) {
    ...
    $_a7p349zwjlnuehs3.set(elem, idAttr$1, id);
    return id;
  };
  var writeOnly = function (elem, uid) {
    $_a7p349zwjlnuehs3.set(elem, idAttr$1, uid);
  };
  var read$2 = function (elem) {
    var id = $_exqx3lykjlnuehc5.isElement(elem) ? $_a7p349zwjlnuehs3.get(elem, idAttr$1) : null;
  ...
  var fromHtml$2 = function (html) {
    ...
    var children = $_8ewcplynjlnuehce.children(elem);
    var attrs = getAttrs(elem);
    var classes = getClasses(elem);
    var contents = children.length === 0 ? {} : { innerHtml: $_9yuaun10fjlnuehx4.get(elem) };
    return deepMerge({
      tag: $_exqx3lykjlnuehc5.name(elem),
      classes: classes,
      attributes: attrs
    }, contents);
  };
  ...
  var dom$1 = function (rawHtml) {
    var html = supplant(rawHtml, { prefix: $_e6ep1c10tjlnuei33.prefix() });
  ...
  var getToggleBehaviours = function (command) {
    return derive$2([
      Toggling.config({
        toggleClass: $_e6ep1c10tjlnuei33.resolve('toolbar-button-selected'),
        toggleOnExecute: false,
        aria: { mode: 'pressed' }
      }),
      $_3pq36o10sjlnuei2t.format(command, function (button, status) {
  ...
  var isTouch = $_c4pfxvy3jlnueh7s.detect().deviceType.isTouch();
  ...
  var platform = $_c4pfxvy3jlnueh7s.detect();
  ...
  var isTouch$2 = $_c4pfxvy3jlnueh7s.detect().deviceType.isTouch();
  var SliderSchema = [
    strict$1('min'),
    strict$1('max'),
  ...
  var setMax$1 = function (element, value) {
    ...
    $_av4glr116jlnuei7e.set(element, 'max-width', absMax + 'px');
  };
  var $_b9pchq130jlnuej3b = {
    set: set$4,
    get: get$6,
    getOuter: getOuter$2,
    setMax: setMax$1
  ...
  var isTouch$3 = $_c4pfxvy3jlnueh7s.detect().deviceType.isTouch();
  var sketch$1 = function (detail, components$$1, spec, externals) {
    ...
    var refresh = function (component) {
      ...
      var thumbRadius = $_b9pchq130jlnuej3b.get(thumb.element()) / 2;
      $_av4glr116jlnuei7e.set(thumb.element(), 'left', pos - thumbRadius + 'px');
    };
    var changeValue = function (component, newValue) {
      var oldValue = detail.value().get();
      var thumb = getThumb(component);
      if (oldValue !== newValue || $_av4glr116jlnuei7e.getRaw(thumb.element(), 'left').isNone()) {
  ...
  var button = function (realm, clazz, makeItems) {
    return $_d2s15g10ujlnuei38.forToolbar(clazz, function () {
      var items = makeItems();
  ...
  var makeSlider = function (spec$$1) {
    ...
    var onInit = function (slider, thumb, value) {
      ...
      $_av4glr116jlnuei7e.set(thumb.element(), 'background-color', color);
    };
    ...
    return Slider.sketch({
      ...
      components: [
        ...
        Slider.parts().spectrum({
          ...
          behaviours: derive$2([Toggling.config({ toggleClass: $_e6ep1c10tjlnuei33.resolve('thumb-active') })])
        }),
      ...
      sliderBehaviours: derive$2([$_3pq36o10sjlnuei2t.orientation(Slider.refresh)])
    });
  };
  ...
  var sketch$3 = function (rawSpec) {
    ...
    return Slider.sketch({
      dom: {
        tag: 'div',
        classes: [
          $_e6ep1c10tjlnuei33.resolve('slider-' + spec$$1.category + '-size-container'),
          $_e6ep1c10tjlnuei33.resolve('slider'),
          $_e6ep1c10tjlnuei33.resolve('slider-size-container')
        ]
      },
      onChange: onChange,
      onDragStart: function (slider, thumb) {
  ...
  var $_eadd4n133jlnuej3i = { sketch: sketch$3 };
  ...
  var getRawOrComputed = function (isRoot, rawStart) {
    var optStart = $_exqx3lykjlnuehc5.isElement(rawStart) ? Option.some(rawStart) : $_8ewcplynjlnuehce.parent(rawStart);
    return optStart.map(function (start) {
      var inline = $_6b680c103jlnuehtq.closest(start, function (elem) {
        return $_av4glr116jlnuei7e.getRaw(elem, 'font-size').isSome();
      }, isRoot).bind(function (elem) {
        return $_av4glr116jlnuei7e.getRaw(elem, 'font-size');
      });
      return inline.getOrThunk(function () {
        return $_av4glr116jlnuei7e.get(start, 'font-size');
      });
    }).getOr('');
  };
  var getSize = function (editor) {
    ...
    var isRoot = function (e) {
      return $_1163wgytjlnuehdl.eq(root, e);
    };
  ...
  var $_dtkh8v134jlnuej4a = {
    candidates: constant(candidates),
    get: get$7,
    apply: apply$1
  };

  var sizes = $_dtkh8v134jlnuej4a.candidates();
  var makeSlider$1 = function (spec$$1) {
    return $_eadd4n133jlnuej3i.sketch({
  ...
  var sketch$4 = function (realm, editor) {
    var spec$$1 = {
      onChange: function (value) {
        $_dtkh8v134jlnuej4a.apply(editor, value);
      },
      getInitialValue: function () {
        return $_dtkh8v134jlnuej4a.get(editor);
      }
    };
  ...
  function Blob (parts, properties) {
    var f = $_4brph3yvjlnuehec.getOrDie('Blob');
    return new f(parts, properties);
  }

  function FileReader () {
    var f = $_4brph3yvjlnuehec.getOrDie('FileReader');
    return new f();
  }

  function Uint8Array (arr) {
    var f = $_4brph3yvjlnuehec.getOrDie('Uint8Array');
    return new f(arr);
  }

  var requestAnimationFrame = function (callback) {
    var f = $_4brph3yvjlnuehec.getOrDie('requestAnimationFrame');
    f(callback);
  };
  var atob = function (base64) {
    var f = $_4brph3yvjlnuehec.getOrDie('atob');
    return f(base64);
  };
  var $_22gmap13fjlnuej8f = {
    atob: atob,
  ...
  function dataUriToBlobSync(uri) {
    ...
    var base64 = data[1];
    var sliceSize = 1024;
    var byteCharacters = $_22gmap13fjlnuej8f.atob(base64);
  ...
  function blobToCanvas(blob) {
    return blobToImage(blob).then(function (image) {
      ...
      var context, canvas;
      canvas = $_1zu4fs139jlnuej81.create($_69mdeo13ajlnuej83.getWidth(image), $_69mdeo13ajlnuej83.getHeight(image));
      context = $_1zu4fs139jlnuej81.get2dContext(canvas);
  ...
  var blobToImage$1 = function (image) {
    return $_enonyn138jlnuej6x.blobToImage(image);
  };
  var imageToBlob$1 = function (blob) {
    return $_enonyn138jlnuej6x.imageToBlob(blob);
  };
  var blobToDataUri$1 = function (blob) {
    return $_enonyn138jlnuej6x.blobToDataUri(blob);
  };
  var blobToBase64$1 = function (blob) {
    return $_enonyn138jlnuej6x.blobToBase64(blob);
  };
  var dataUriToBlobSync$1 = function (uri) {
    return $_enonyn138jlnuej6x.dataUriToBlobSync(uri);
  };
  var uriToBlob$1 = function (uri) {
    return Option.from($_enonyn138jlnuej6x.uriToBlob(uri));
  };
  var $_bjx70u137jlnuej6p = {
  ...
  var addImage = function (editor, blob) {
    $_bjx70u137jlnuej6p.blobToBase64(blob).then(function (base64) {
      editor.undoManager.transact(function () {
  ...
  var fromLink = function (link) {
    var text = $_7yt4px13ijlnuej9m.get(link);
    var url = $_a7p349zwjlnuehs3.get(link, 'href');
    var title = $_a7p349zwjlnuehs3.get(link, 'title');
    var target = $_a7p349zwjlnuehs3.get(link, 'target');
    return {
  ...
  var wasSimple = function (link) {
    var prevHref = $_a7p349zwjlnuehs3.get(link, 'href');
    var prevText = $_7yt4px13ijlnuej9m.get(link);
  ...
  var applyInfo = function (editor, info) {
    info.url.filter(isNotEmpty).fold(function () {
      ...
      activeLink.fold(function () {
        ...
        $_a7p349zwjlnuehs3.setAll(link, attrs);
        text.each(function (newText) {
          $_7yt4px13ijlnuej9m.set(link, newText);
        });
      });
    });
  };
  var query = function (editor) {
    ...
    return $_4cszdu11bjlnuei8x.closest(start, 'a');
  };
  var $_1qee4a13hjlnuej8v = {
    getInfo: getInfo,
    applyInfo: applyInfo,
    query: query
  };

  var platform$1 = $_c4pfxvy3jlnueh7s.detect();
  ...
  var $_boxdg613jjlnuej9o = { forAndroid: forAndroid };
  ...
  var focusBehaviours = function (detail) {
    return derive$2([Focusing.config({
        onFocus: detail.selectOnFocus() === false ? noop : function (component) {
          ...
          var value = $_9pjr1x13tjlnueje8.get(input);
    ...
    return deepMerge(derive$2([Representing.config({
        store: {
          ...
          getValue: function (input) {
            return $_9pjr1x13tjlnueje8.get(input.element());
          },
          setValue: function (input, data) {
            var current = $_9pjr1x13tjlnueje8.get(input.element());
            if (current !== data) {
              $_9pjr1x13tjlnueje8.set(input.element(), data);
            }
          }
        },
    ...
    return {
      ...
      spec: Container.sketch({
        ...
        containerBehaviours: derive$2([
          Toggling.config({ toggleClass: $_e6ep1c10tjlnuei33.resolve('input-container-empty') }),
          Composing.config({
            find: function (comp) {
  ...
  var hasNative = function (component) {
    return contains(nativeDisabled, $_exqx3lykjlnuehc5.name(component.element()));
  };
  var nativeIsDisabled = function (component) {
    return $_a7p349zwjlnuehs3.has(component.element(), 'disabled');
  };
  var nativeDisable = function (component) {
    $_a7p349zwjlnuehs3.set(component.element(), 'disabled', 'disabled');
  };
  var nativeEnable = function (component) {
    $_a7p349zwjlnuehs3.remove(component.element(), 'disabled');
  };
  var ariaIsDisabled = function (component) {
    return $_a7p349zwjlnuehs3.get(component.element(), 'aria-disabled') === 'true';
  };
  var ariaDisable = function (component) {
    $_a7p349zwjlnuehs3.set(component.element(), 'aria-disabled', 'true');
  };
  var ariaEnable = function (component) {
    $_a7p349zwjlnuehs3.set(component.element(), 'aria-disabled', 'false');
  };
  var disable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_1tj8hmzujlnuehrz.add(component.element(), disableClass);
    });
  ...
  var enable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_1tj8hmzujlnuehrz.remove(component.element(), disableClass);
    });
  ...
  var sketch$7 = function (rawSpec) {
    ...
    var navigationButton = function (direction, directionName, enabled) {
      return Button.sketch({
        ...
        buttonBehaviours: derive$2([Disabling.config({
            disableClass: $_e6ep1c10tjlnuei33.resolve('toolbar-navigation-disabled'),
            disabled: !enabled
          })])
      });
    };
    var reposition = function (dialog, message) {
      $_4cszdu11bjlnuei8x.descendant(dialog.element(), '.' + $_e6ep1c10tjlnuei33.resolve('serialised-dialog-chain')).each(function (parent) {
        $_av4glr116jlnuei7e.set(parent, 'left', -spec$$1.state.currentScreen.get() * message.width + 'px');
      });
    };
    var navigate = function (dialog, direction) {
      var screens = $_ff9i66119jlnuei8o.descendants(dialog.element(), '.' + $_e6ep1c10tjlnuei33.resolve('serialised-dialog-screen'));
      $_4cszdu11bjlnuei8x.descendant(dialog.element(), '.' + $_e6ep1c10tjlnuei33.resolve('serialised-dialog-chain')).each(function (parent) {
        if (spec$$1.state.currentScreen.get() + direction >= 0 && spec$$1.state.currentScreen.get() + direction < screens.length) {
          $_av4glr116jlnuei7e.getRaw(parent, 'left').each(function (left) {
            var currentLeft = parseInt(left, 10);
            var w = $_b9pchq130jlnuej3b.get(screens[0]);
            $_av4glr116jlnuei7e.set(parent, 'left', currentLeft - direction * w + 'px');
          });
    ...
    var focusInput = function (dialog) {
      var inputs = $_ff9i66119jlnuei8o.descendants(dialog.element(), 'input');
    ...
    var memForm = record(Form.sketch(function (parts) {
      return {
        ...
        formBehaviours: derive$2([
          $_3pq36o10sjlnuei2t.orientation(function (dialog, message) {
    ...
    var memDots = record({
      ...
      behaviours: derive$2([Highlighting.config({
          highlightClass: $_e6ep1c10tjlnuei33.resolve('dot-active'),
          itemClass: $_e6ep1c10tjlnuei33.resolve('dot-item')
        })]),
      ...
      behaviours: derive$2([
        ...
        config(wrapperAdhocEvents, [
          run(touchstart(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.set($_guiar144jlnuejj4.init(event.touches[0].clientX));
          }),
          run(touchmove(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.on(function (state) {
              simulatedEvent.event().prevent();
              spec$$1.state.dialogSwipeState.set($_guiar144jlnuejj4.move(state, event.raw().touches[0].clientX));
            });
          }),
          run(touchend(), function (wrapper) {
            spec$$1.state.dialogSwipeState.on(function (state) {
              var dialog = memForm.get(wrapper);
              var direction = -1 * $_guiar144jlnuejj4.complete(state);
              navigate(dialog, direction);
            });
          })
        ])
  ...
  var getGroups = cached(function (realm, editor) {
    return [{
        ...
        items: [sketch$7({
            ...
            getInitialValue: function () {
              return Option.some($_1qee4a13hjlnuej8v.getInfo(editor));
            },
            onExecute: function (dialog) {
              var info = Representing.getValue(dialog);
              $_1qee4a13hjlnuej8v.applyInfo(editor, info);
  ...
  var sketch$8 = function (realm, editor) {
    return $_d2s15g10ujlnuei38.forToolbarStateAction(editor, 'link', 'link', function () {
      var groups = getGroups(realm, editor);
      realm.setContextToolbar(groups);
      $_boxdg613jjlnuej9o.forAndroid(editor, function () {
        realm.focusToolbar();
      });
      $_1qee4a13hjlnuej8v.query(editor).each(function (link) {
  ...
  var isRecursive = function (component, originator, target) {
    return $_1163wgytjlnuehdl.eq(originator, component.element()) && !$_1163wgytjlnuehdl.eq(originator, target);
  };
  ...
  var generateFrom = function (spec, all) {
    ...
    var validated = asStruct('component.behaviours', objOf(schema), spec.behaviours).fold(function (errInfo) {
      throw new Error(formatError(errInfo) + '\nComplete spec:\n' + $_al0vefzhjlnuehlm.stringify(spec, null, 2));
    }, function (v) {
      return v;
    });
    return {
  ...
  var onlyOne = function (chain, aspect) {
    if (chain.length > 1) {
      return Result.error('Multiple behaviours have tried to change DOM "' + aspect + '". The guilty behaviours are: ' + $_al0vefzhjlnuehlm.stringify(map$1(chain, function (b) {
        return b.name();
  ...
  var duplicate = function (aspect, k, obj, behaviours) {
    return Result.error('Mulitple behaviours have tried to change the _' + k + '_ "' + aspect + '"' + '. The guilty behaviours are: ' + $_al0vefzhjlnuehlm.stringify(bind(behaviours, function (b) {
  ...
  var sortKeys = function (label, keyName, array, order) {
    ...
    try {
      var sorted = sliced.sort(function (a, b) {
        ...
        if (aIndex === -1) {
          throw new Error('The ordering for ' + label + ' does not have an entry for ' + aKey + '.\nOrder specified: ' + $_al0vefzhjlnuehlm.stringify(order, null, 2));
        }
        if (bIndex === -1) {
  ...
  var missingOrderError = function (eventName, tuples) {
    return Result.error(['The event (' + eventName + ') has more than one behaviour that listens to it.\nWhen this occurs, you must ' + 'specify an event ordering for the behaviours in your spec (e.g. [ "listing", "toggling" ]).\nThe behaviours that ' + 'can trigger it are: ' + $_al0vefzhjlnuehlm.stringify(map$1(tuples, function (c) {
        return c.name();
      }), null, 2)]);
  };
  ...
  var add$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_1tj8hmzujlnuehrz.add(element, x);
    });
  };
  var remove$6 = function (element, classes) {
    each$1(classes, function (x) {
      $_1tj8hmzujlnuehrz.remove(element, x);
    });
  };
  var toggle$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_1tj8hmzujlnuehrz.toggle(element, x);
    });
  };
  var hasAll = function (element, classes) {
    return forall(classes, function (clazz) {
      return $_1tj8hmzujlnuehrz.has(element, clazz);
    });
  };
  ...
  var get$10 = function (element) {
    return $_9skks0zxjlnuehsp.supports(element) ? getNative(element) : $_9skks0zxjlnuehsp.get(element);
  };
  var $_bs4yeq14mjlnuejw9 = {
    add: add$3,
    remove: remove$6,
    toggle: toggle$3,
    hasAll: hasAll,
  ...
  var renderToDom = function (definition) {
    ...
    $_a7p349zwjlnuehs3.setAll(subject, definition.attributes().getOr({}));
    $_bs4yeq14mjlnuejw9.add(subject, definition.classes().getOr([]));
    $_av4glr116jlnuei7e.setAll(subject, definition.styles().getOr({}));
    $_9yuaun10fjlnuehx4.set(subject, definition.innerHtml().getOr(''));
    var children = getChildren(definition);
    $_24dkeiz0jlnuehfb.append(subject, children);
    definition.value().each(function (value) {
      $_9pjr1x13tjlnueje8.set(subject, value);
    });
    return subject;
  };
  ...
  var build = function (spec) {
    ...
    var syncComponents = function () {
      var children = $_8ewcplynjlnuehce.children(item);
    ...
    var config = function (behaviour) {
      ...
      var f = isFunction(b[behaviour.name()]) ? b[behaviour.name()] : function () {
        throw new Error('Could not find ' + behaviour.name() + ' in ' + $_al0vefzhjlnuehlm.stringify(spec, null, 2));
      };
      return f();
    };
  ...
  var onHover = function (item) {
    if ($_dq8hw101jlnuehtb.search(item.element()).isNone() || Focusing.isFocused(item)) {
  ...
  var preserve$2 = function (f, container) {
    var ownerDoc = $_8ewcplynjlnuehce.owner(container);
    var refocus = $_dq8hw101jlnuehtb.active(ownerDoc).bind(function (focused) {
      var hasFocus = function (elem) {
        return $_1163wgytjlnuehdl.eq(focused, elem);
      };
      return hasFocus(container) ? Option.some(container) : $_6b680c103jlnuehtq.descendant(container, hasFocus);
    });
    var result = f(container);
    refocus.each(function (oldFocus) {
      $_dq8hw101jlnuehtb.active(ownerDoc).filter(function (newFocus) {
        return $_1163wgytjlnuehdl.eq(newFocus, oldFocus);
      }).fold(function () {
        $_dq8hw101jlnuehtb.focus(oldFocus);
      }, noop);
    });
    return result;
  };
  ...
  var append$2 = function (component, replaceConfig, replaceState, appendee) {
    insert(component, replaceConfig, $_5naldxymjlnuehcb.append, appendee);
  };
  var prepend$2 = function (component, replaceConfig, replaceState, prependee) {
    insert(component, replaceConfig, $_5naldxymjlnuehcb.prepend, prependee);
  };
  var remove$7 = function (component, replaceConfig, replaceState, removee) {
    var children = contents(component, replaceConfig);
    var foundChild = find$2(children, function (child) {
      return $_1163wgytjlnuehdl.eq(removee.element(), child.element());
    });
  ...
  var make$3 = function (detail, rawUiSpec) {
    ...
    var updateMenuPath = function (container, state, path) {
      return Option.from(path[0]).bind(state.lookupMenu).map(function (activeMenu) {
        ...
        each$1(rest, function (r) {
          $_1tj8hmzujlnuehrz.add(r.element(), detail.markers().backgroundMenu());
        });
        if (!$_7usjeyyijlnuehbd.inBody(activeMenu.element())) {
          Replacing.append(container, premade$1(activeMenu));
        }
        $_bs4yeq14mjlnuejw9.remove(activeMenu.element(), [detail.markers().backgroundMenu()]);
        setActiveMenu(container, activeMenu);
        var others = getMenus(state, state.otherMenus(path));
        each$1(others, function (o) {
          $_bs4yeq14mjlnuejw9.remove(o.element(), [detail.markers().backgroundMenu()]);
          if (!detail.stayInDom()) {
    ...
    var keyOnItem = function (f) {
      return function (container, simulatedEvent) {
        return $_4cszdu11bjlnuei8x.closest(simulatedEvent.getSource(), '.' + detail.markers().item()).bind(function (target) {
  ...
  var disableTransition = function (comp, transConfig, transState) {
    getTransition(comp, transConfig, transState).each(function (routeTransition) {
      ...
      $_1tj8hmzujlnuehrz.remove(comp.element(), t.transitionClass());
      $_a7p349zwjlnuehs3.remove(comp.element(), transConfig.destinationAttr());
    });
  };
  var getNewRoute = function (comp, transConfig, transState, destination) {
    return {
      start: constant($_a7p349zwjlnuehs3.get(comp.element(), transConfig.stateAttr())),
      destination: constant(destination)
    };
  };
  var getCurrentRoute = function (comp, transConfig, transState) {
    var el = comp.element();
    return $_a7p349zwjlnuehs3.has(el, transConfig.destinationAttr()) ? Option.some({
      start: constant($_a7p349zwjlnuehs3.get(comp.element(), transConfig.stateAttr())),
      destination: constant($_a7p349zwjlnuehs3.get(comp.element(), transConfig.destinationAttr()))
    }) : Option.none();
  };
  var jumpTo = function (comp, transConfig, transState, destination) {
    disableTransition(comp, transConfig, transState);
    if ($_a7p349zwjlnuehs3.has(comp.element(), transConfig.stateAttr()) && $_a7p349zwjlnuehs3.get(comp.element(), transConfig.stateAttr()) !== destination) {
      transConfig.onFinish()(comp, destination);
    }
    $_a7p349zwjlnuehs3.set(comp.element(), transConfig.stateAttr(), destination);
  };
  var fasttrack = function (comp, transConfig, transState, destination) {
    if ($_a7p349zwjlnuehs3.has(comp.element(), transConfig.destinationAttr())) {
      $_a7p349zwjlnuehs3.set(comp.element(), transConfig.stateAttr(), $_a7p349zwjlnuehs3.get(comp.element(), transConfig.destinationAttr()));
      $_a7p349zwjlnuehs3.remove(comp.element(), transConfig.destinationAttr());
    }
  };
  var progressTo = function (comp, transConfig, transState, destination) {
    ...
    getTransitionOf(comp, transConfig, transState, route).fold(function () {
      ...
      disableTransition(comp, transConfig, transState);
      var t = routeTransition.transition();
      $_1tj8hmzujlnuehrz.add(comp.element(), t.transitionClass());
      $_a7p349zwjlnuehs3.set(comp.element(), transConfig.destinationAttr(), destination);
    });
  };
  var getState = function (comp, transConfig, transState) {
    var e = comp.element();
    return $_a7p349zwjlnuehs3.has(e, transConfig.stateAttr()) ? Option.some($_a7p349zwjlnuehs3.get(e, transConfig.stateAttr())) : Option.none();
  };
  ...
  var scrollable = $_e6ep1c10tjlnuei33.resolve('scrollable');
  var register = function (element) {
    $_1tj8hmzujlnuehrz.add(element, scrollable);
  };
  var deregister = function (element) {
    $_1tj8hmzujlnuehrz.remove(element, scrollable);
  };
  var $_g7b46t159jlnuek8r = {
    register: register,
  ...
  var makeItem = function (value, text$$1, selected, preview, isMenu) {
    return {
      ...
      dom: {
        tag: 'div',
        classes: isMenu ? [$_e6ep1c10tjlnuei33.resolve('styles-item-is-menu')] : []
      },
      toggling: {
        toggleOnExecute: false,
        toggleClass: $_e6ep1c10tjlnuei33.resolve('format-matches'),
        selected: selected
      },
      itemBehaviours: derive$2(isMenu ? [] : [$_3pq36o10sjlnuei2t.format(value, function (comp, status) {
          var toggle = status ? Toggling.on : Toggling.off;
          toggle(comp);
        })]),
      components: [{
    ...
    return {
      ...
      components: [
        Button.sketch({
          dom: {
            tag: 'div',
            classes: [$_e6ep1c10tjlnuei33.resolve('styles-collapser')]
          },
          components: collapsable ? [
            {
              dom: {
                tag: 'span',
                classes: [$_e6ep1c10tjlnuei33.resolve('styles-collapse-icon')]
              }
            },
            text(value)
          ] : [text(value)],
        ...
        }),
        {
          dom: {
            tag: 'div',
            classes: [$_e6ep1c10tjlnuei33.resolve('styles-menu-items-container')]
          },
          components: [Menu.parts().items({})],
          behaviours: derive$2([config('adhoc-scrollable-menu', [
              runOnAttached(function (component, simulatedEvent) {
                $_av4glr116jlnuei7e.set(component.element(), 'overflow-y', 'auto');
                $_av4glr116jlnuei7e.set(component.element(), '-webkit-overflow-scrolling', 'touch');
                $_g7b46t159jlnuek8r.register(component.element());
              }),
              runOnDetached(function (component) {
                $_av4glr116jlnuei7e.remove(component.element(), 'overflow-y');
                $_av4glr116jlnuei7e.remove(component.element(), '-webkit-overflow-scrolling');
                $_g7b46t159jlnuek8r.deregister(component.element());
              })
            ])])
        }
      ],
  ...
  var sketch$9 = function (settings) {
    ...
    var memMenu = record(tieredMenu.sketch({
      dom: {
        tag: 'div',
        classes: [$_e6ep1c10tjlnuei33.resolve('styles-menu')]
      },
      components: [],
      fakeFocus: true,
      stayInDom: true,
      ...
      onOpenMenu: function (container, menu) {
        var w = $_b9pchq130jlnuej3b.get(container.element());
        $_b9pchq130jlnuej3b.set(menu.element(), w);
        Transitioning.jumpTo(menu, 'current');
      },
      onOpenSubmenu: function (container, item, submenu) {
        var w = $_b9pchq130jlnuej3b.get(container.element());
        var menu = $_4cszdu11bjlnuei8x.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
        var menuComp = container.getSystem().getByDom(menu).getOrDie();
        $_b9pchq130jlnuej3b.set(submenu.element(), w);
        Transitioning.progressTo(menuComp, 'before');
        Transitioning.jumpTo(submenu, 'after');
        Transitioning.progressTo(submenu, 'current');
      },
      onCollapseMenu: function (container, item, menu) {
        var submenu = $_4cszdu11bjlnuei8x.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
      ...
      data: dataset.tmenu,
      markers: {
        backgroundMenu: $_e6ep1c10tjlnuei33.resolve('styles-background-menu'),
        menu: $_e6ep1c10tjlnuei33.resolve('styles-menu'),
        selectedMenu: $_e6ep1c10tjlnuei33.resolve('styles-selected-menu'),
        item: $_e6ep1c10tjlnuei33.resolve('styles-item'),
        selectedItem: $_e6ep1c10tjlnuei33.resolve('styles-selected-item')
      }
    }));
    return memMenu.asSpec();
  };
  var $_1fangq147jlnuejk0 = { sketch: sketch$9 };
  ...
  var $_csfvfm15ajlnuek93 = { expand: expand };
  ...
  var prune = function (editor, formats) {
    ...
    return $_csfvfm15ajlnuek93.expand(prunedItems);
  };
  var ui = function (editor, formats, onDone) {
    var pruned = prune(editor, formats);
    return $_1fangq147jlnuejk0.sketch({
      formats: pruned,
  ...
  var setup = function (realm, editor) {
    var commandSketch = function (name) {
      return function () {
        return $_d2s15g10ujlnuei38.forToolbarCommand(editor, name);
      };
    };
    var stateCommandSketch = function (name) {
      return function () {
        return $_d2s15g10ujlnuei38.forToolbarStateCommand(editor, name);
      };
    };
    var actionSketch = function (name, query, action) {
      return function () {
        return $_d2s15g10ujlnuei38.forToolbarStateAction(editor, name, query, action);
      };
    };
    ...
    var forecolor = function () {
      return $_e6dla212kjlnueixf.sketch(realm, editor);
    };
    var styleFormats = $_dqgy6n145jlnuejj6.register(editor, editor.settings);
    var styleFormatsMenu = function () {
      return $_dqgy6n145jlnuejj6.ui(editor, styleFormats, function () {
        editor.fire('scrollIntoView');
      });
    };
    var styleselect = function () {
      return $_d2s15g10ujlnuei38.forToolbar('style-formats', function (button) {
        ...
        Receiving.config({
          channels: wrapAll$1([
            $_3pq36o10sjlnuei2t.receive($_djvm81109jlnuehv2.orientationChanged(), Toggling.off),
            $_3pq36o10sjlnuei2t.receive($_djvm81109jlnuehv2.dropupDismissed(), Toggling.off)
          ])
        })
      ]));
    };
  ...
  var bind$2 = function (element, event, handler) {
    return $_2qxd7g15djlnuekal.bind(element, event, filter$1, handler);
  };
  var capture$1 = function (element, event, handler) {
    return $_2qxd7g15djlnuekal.capture(element, event, filter$1, handler);
  };
  var $_66gcec15cjlnuekae = {
    bind: bind$2,
    capture: capture$1
  };
  ...
  var getActualWidth = function (outerWindow) {
    var isIos = $_c4pfxvy3jlnueh7s.detect().os.isiOS();
  ...
  var onChange = function (outerWindow, listeners) {
    ...
    var orientationHandle = $_66gcec15cjlnuekae.bind(win, 'orientationchange', change);
  ...
  var monitor = function (settings) {
    ...
    var handleTouchend = function (event) {
      ...
      var isSame = function (data) {
        return $_1163wgytjlnuehdl.eq(data.target(), event.target());
      };
  ...
  var monitor$1 = function (editorApi) {
    ...
    var onTouchend = function () {
      return $_66gcec15cjlnuekae.bind(editorApi.body(), 'touchend', function (evt) {
        tapEvent.fireIfReady(evt, 'touchend');
      });
    };
    var onTouchmove = function () {
      return $_66gcec15cjlnuekae.bind(editorApi.body(), 'touchmove', function (evt) {
  ...
  var $_8j5fvk15ijlnuekdq = { monitor: monitor$1 };

  var isAndroid6 = $_c4pfxvy3jlnueh7s.detect().os.version.major >= 6;
  var initEvents = function (editorApi, toolstrip, alloy) {
    var tapping = $_8j5fvk15ijlnuekdq.monitor(editorApi);
    var outerDoc = $_8ewcplynjlnuehce.owner(toolstrip);
    var isRanged = function (sel) {
      return !$_1163wgytjlnuehdl.eq(sel.start(), sel.finish()) || sel.soffset() !== sel.foffset();
    };
    var hasRangeInUi = function () {
      return $_dq8hw101jlnuehtb.active(outerDoc).filter(function (input) {
        return $_exqx3lykjlnuehc5.name(input) === 'input';
    ...
    var listeners = [
      $_66gcec15cjlnuekae.bind(editorApi.body(), 'touchstart', function (evt) {
        editorApi.onTouchContent();
        tapping.fireTouchstart(evt);
      }),
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_66gcec15cjlnuekae.bind(toolstrip, 'touchstart', function (evt) {
        editorApi.onTouchToolstrip();
      }),
      editorApi.onToReading(function () {
        $_dq8hw101jlnuehtb.blur(editorApi.body());
      }),
      ...
      $_66gcec15cjlnuekae.bind(Element$$1.fromDom(editorApi.win()), 'blur', function () {
        alloy.getByDom(toolstrip).each(Toggling.off);
      }),
      $_66gcec15cjlnuekae.bind(outerDoc, 'select', updateMargin),
      $_66gcec15cjlnuekae.bind(editorApi.doc(), 'selectionchange', updateMargin)
    ]);
    var destroy = function () {
  ...
  var $_ggwuah15hjlnuekcc = { initEvents: initEvents };

  var safeParse = function (element, attribute) {
    var parsed = parseInt($_a7p349zwjlnuehs3.get(element, attribute), 10);
    return isNaN(parsed) ? 0 : parsed;
  };
  var $_gadk3415mjlnuekg9 = { safeParse: safeParse };
  ...
  var api$3 = NodeValue($_exqx3lykjlnuehc5.isText, 'text');
  ...
  var getEnd = function (element) {
    return $_exqx3lykjlnuehc5.name(element) === 'img' ? 1 : $_8prn0s15pjlnuekhr.getOption(element).fold(function () {
      return $_8ewcplynjlnuehce.children(element).length;
    }, function (v) {
      return v.length;
    });
  };
  ...
  var isTextNodeWithCursorPosition = function (el) {
    return $_8prn0s15pjlnuekhr.getOption(el).filter(function (text) {
  ...
  var isCursorPosition = function (elem) {
    ...
    return hasCursorPosition || contains(elementsWithCursorPosition, $_exqx3lykjlnuehc5.name(elem));
  };
  var $_bf19aa15ojlnuekhi = {
    getEnd: getEnd,
    isEnd: isEnd,
    isStart: isStart,
  ...
  var getStart$1 = function (selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return $_5djsi515sjlnuekik.getStart(startSitu);
      },
  ...
  var getWin = function (selection) {
    ...
    return $_8ewcplynjlnuehce.defaultView(start);
  };
  var $_b4pzaq15rjlnueki6 = {
  ...
  var makeRange = function (start, soffset, finish, foffset) {
    var doc = $_8ewcplynjlnuehce.owner(start);
  ...
  var after$2 = function (start, soffset, finish, foffset) {
    var r = makeRange(start, soffset, finish, foffset);
    var same = $_1163wgytjlnuehdl.eq(start, finish) && soffset === foffset;
    return r.collapsed && !same;
  };
  var $_529e4815ujlnuekja = {
    after: after$2,
  ...
  var $_7obked15vjlnuekjd = { fromElements: fromElements };
  ...
  var getRanges = function (win, selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return {
          ltr: cached(function () {
            return $_3rd4k815wjlnuekjn.relativeToNative(win, startSitu, finishSitu);
          }),
          rtl: cached(function () {
            return Option.some($_3rd4k815wjlnuekjn.relativeToNative(win, finishSitu, startSitu));
          })
        };
      },
      exact: function (start, soffset, finish, foffset) {
        return {
          ltr: cached(function () {
            return $_3rd4k815wjlnuekjn.exactToNative(win, start, soffset, finish, foffset);
          }),
          rtl: cached(function () {
            return Option.some($_3rd4k815wjlnuekjn.exactToNative(win, finish, foffset, start, soffset));
          })
        };
      }
    });
  ...
  var locateOffset = function (doc, textnode, x, y, rect) {
    ...
    var length = $_8prn0s15pjlnuekhr.get(textnode).length;
    var offset = $_cjolh6160jlnueklk.searchForPoint(rectForOffset, x, y, rect.right, length);
  ...
  var locate$1 = function (doc, node, x, y) {
    ...
    var foundRect = findMap(rects, function (rect) {
      return $_cjolh6160jlnueklk.inRect(rect, x, y) ? Option.some(rect) : Option.none();
    });
    return foundRect.map(function (rect) {
      return locateOffset(doc, node, x, y, rect);
    });
  };
  var $_a3vrx1161jlnueklm = { locate: locate$1 };

  var searchInChildren = function (doc, node, x, y) {
    var r = doc.dom().createRange();
    var nodes = $_8ewcplynjlnuehce.children(node);
    return findMap(nodes, function (n) {
      r.selectNode(n.dom());
      return $_cjolh6160jlnueklk.inRect(r.getBoundingClientRect(), x, y) ? locateNode(doc, n, x, y) : Option.none();
    });
  };
  var locateNode = function (doc, node, x, y) {
    var locator = $_exqx3lykjlnuehc5.isText(node) ? $_a3vrx1161jlnueklm.locate : searchInChildren;
  ...
  var $_jcb0i15zjlnuekl5 = { locate: locate$2 };

  var first$3 = function (element) {
    return $_6b680c103jlnuehtq.descendant(element, $_bf19aa15ojlnuekhi.isCursorPosition);
  };
  var last$2 = function (element) {
    return descendantRtl(element, $_bf19aa15ojlnuekhi.isCursorPosition);
  };
  var descendantRtl = function (scope, predicate) {
    var descend = function (element) {
      var children = $_8ewcplynjlnuehce.children(element);
  ...
  var locateInElement = function (doc, node, x) {
    ...
    var f = collapseDirection === COLLAPSE_TO_LEFT ? $_f2kydz163jlnuekm9.first : $_f2kydz163jlnuekm9.last;
  ...
  var search$1 = function (doc, node, x) {
    var f = $_8ewcplynjlnuehce.children(node).length === 0 ? locateInEmpty : locateInElement;
    return f(doc, node, x);
  };
  var $_gccus2162jlnuekm1 = { search: search$1 };
  ...
  var searchTextNodes = function (doc, node, x, y) {
    ...
    var boundedX = Math.max(rect.left, Math.min(rect.right, x));
    var boundedY = Math.max(rect.top, Math.min(rect.bottom, y));
    return $_jcb0i15zjlnuekl5.locate(doc, node, boundedX, boundedY);
  };
  var searchFromPoint = function (doc, x, y) {
    return Element$$1.fromPoint(doc, x, y).bind(function (elem) {
      var fallback = function () {
        return $_gccus2162jlnuekm1.search(doc, elem, x);
      };
      return $_8ewcplynjlnuehce.children(elem).length === 0 ? fallback() : searchTextNodes(doc, elem, x, y).orThunk(fallback);
    });
  };
  ...
  var fromPoint$1 = function (win, x, y) {
    ...
    return availableSearch(doc, x, y).map(function (rng) {
      return $_b4pzaq15rjlnueki6.range(Element$$1.fromDom(rng.startContainer), rng.startOffset, Element$$1.fromDom(rng.endContainer), rng.endOffset);
    });
  };
  var $_fk2lxm15yjlnuekkx = { fromPoint: fromPoint$1 };

  var withinContainer = function (win, ancestor, outerRange, selector) {
    var innerRange = $_3rd4k815wjlnuekjn.create(win);
    var self = $_19vj3yyyjlnuehep.is(ancestor, selector) ? [ancestor] : [];
    var elements = self.concat($_ff9i66119jlnuei8o.descendants(ancestor, selector));
    return filter(elements, function (elem) {
      $_3rd4k815wjlnuekjn.selectNodeContentsUsing(innerRange, elem);
      return $_3rd4k815wjlnuekjn.isWithin(outerRange, innerRange);
    });
  };
  var find$3 = function (win, selection, selector) {
    var outerRange = $_6wk6j115xjlnuekk4.asLtrRange(win, selection);
    var ancestor = Element$$1.fromDom(outerRange.commonAncestorContainer);
    return $_exqx3lykjlnuehc5.isElement(ancestor) ? withinContainer(win, ancestor, outerRange, selector) : [];
  };
  var $_dh59cc164jlnuekml = { find: find$3 };

  var beforeSpecial = function (element, offset) {
    var name = $_exqx3lykjlnuehc5.name(element);
    if ('input' === name)
      return $_5djsi515sjlnuekik.after(element);
    else if (!contains([
        'br',
        'img'
      ], name))
      return $_5djsi515sjlnuekik.on(element, offset);
    else
      return offset === 0 ? $_5djsi515sjlnuekik.before(element) : $_5djsi515sjlnuekik.after(element);
  };
  var preprocessRelative = function (startSitu, finishSitu) {
    var start = startSitu.fold($_5djsi515sjlnuekik.before, beforeSpecial, $_5djsi515sjlnuekik.after);
    var finish = finishSitu.fold($_5djsi515sjlnuekik.before, beforeSpecial, $_5djsi515sjlnuekik.after);
    return $_b4pzaq15rjlnueki6.relative(start, finish);
  };
  var preprocessExact = function (start, soffset, finish, foffset) {
    var startSitu = beforeSpecial(start, soffset);
    var finishSitu = beforeSpecial(finish, foffset);
    return $_b4pzaq15rjlnueki6.relative(startSitu, finishSitu);
  };
  ...
  var doSetRange = function (win, start, soffset, finish, foffset) {
    var rng = $_3rd4k815wjlnuekjn.exactToNative(win, start, soffset, finish, foffset);
    doSetNativeRange(win, rng);
  };
  var findWithin = function (win, selection, selector) {
    return $_dh59cc164jlnuekml.find(win, selection, selector);
  };
  ...
  var setRangeFromRelative = function (win, relative) {
    return $_6wk6j115xjlnuekk4.diagnose(win, relative).match({
      ltr: function (start, soffset, finish, foffset) {
  ...
  var setExact = function (win, start, soffset, finish, foffset) {
    var relative = $_dp5z98165jlnuekmt.preprocessExact(start, soffset, finish, foffset);
    setRangeFromRelative(win, relative);
  };
  var setRelative = function (win, startSitu, finishSitu) {
    var relative = $_dp5z98165jlnuekmt.preprocessRelative(startSitu, finishSitu);
    setRangeFromRelative(win, relative);
  };
  var toNative = function (selection) {
    var win = $_b4pzaq15rjlnueki6.getWin(selection).dom();
    var getDomRange = function (start, soffset, finish, foffset) {
      return $_3rd4k815wjlnuekjn.exactToNative(win, start, soffset, finish, foffset);
    };
    var filtered = $_dp5z98165jlnuekmt.preprocess(selection);
    return $_6wk6j115xjlnuekk4.diagnose(win, filtered).match({
      ltr: getDomRange,
      rtl: getDomRange
    });
  };
  var readRange = function (selection) {
    if (selection.rangeCount > 0) {
      ...
      return Option.some($_b4pzaq15rjlnueki6.range(Element$$1.fromDom(firstRng.startContainer), firstRng.startOffset, Element$$1.fromDom(lastRng.endContainer), lastRng.endOffset));
    } else {
      return Option.none();
    }
  };
  var doGetExact = function (selection) {
    ...
    return $_529e4815ujlnuekja.after(anchorNode, selection.anchorOffset, focusNode, selection.focusOffset) ? Option.some($_b4pzaq15rjlnueki6.range(Element$$1.fromDom(selection.anchorNode), selection.anchorOffset, Element$$1.fromDom(selection.focusNode), selection.focusOffset)) : readRange(selection);
  };
  var setToElement = function (win, element) {
    var rng = $_3rd4k815wjlnuekjn.selectNodeContents(win, element);
    doSetNativeRange(win, rng);
  };
  ...
  var get$13 = function (win) {
    return getExact(win).map(function (range) {
      return $_b4pzaq15rjlnueki6.exact(range.start(), range.soffset(), range.finish(), range.foffset());
    });
  };
  var getFirstRect$1 = function (win, selection) {
    var rng = $_6wk6j115xjlnuekk4.asLtrRange(win, selection);
    return $_3rd4k815wjlnuekjn.getFirstRect(rng);
  };
  var getBounds$1 = function (win, selection) {
    var rng = $_6wk6j115xjlnuekk4.asLtrRange(win, selection);
    return $_3rd4k815wjlnuekjn.getBounds(rng);
  };
  var getAtPoint = function (win, x, y) {
    return $_fk2lxm15yjlnuekkx.fromPoint(win, x, y);
  };
  var getAsString = function (win, selection) {
    var rng = $_6wk6j115xjlnuekk4.asLtrRange(win, selection);
    return $_3rd4k815wjlnuekjn.toString(rng);
  };
  ...
  var clone$3 = function (win, selection) {
    var rng = $_6wk6j115xjlnuekk4.asLtrRange(win, selection);
    return $_3rd4k815wjlnuekjn.cloneFragment(rng);
  };
  var replace = function (win, selection, elements) {
    var rng = $_6wk6j115xjlnuekk4.asLtrRange(win, selection);
    var fragment = $_7obked15vjlnuekjd.fromElements(elements, win.document);
    $_3rd4k815wjlnuekjn.replaceWith(rng, fragment);
  };
  var deleteAt = function (win, selection) {
    var rng = $_6wk6j115xjlnuekk4.asLtrRange(win, selection);
    $_3rd4k815wjlnuekjn.deleteContents(rng);
  };
  var isCollapsed = function (start, soffset, finish, foffset) {
    return $_1163wgytjlnuehdl.eq(start, finish) && soffset === foffset;
  };
  var $_3h97jy15tjlnuekiy = {
    setExact: setExact,
    getExact: getExact,
    get: get$13,
  ...
  var getRectsFromRange = function (range$$1) {
    if (!range$$1.collapsed) {
      ...
      return $_8ewcplynjlnuehce.parent(start_1).bind(function (parent) {
        var selection = $_b4pzaq15rjlnueki6.exact(start_1, range$$1.startOffset, parent, $_bf19aa15ojlnuekhi.getEnd(parent));
        var optRect = $_3h97jy15tjlnuekiy.getFirstRect(range$$1.startContainer.ownerDocument.defaultView, selection);
  ...
  var $_2b6njf15njlnuekgg = { getRectangles: getRectangles };
  ...
  var resume = function (cWin) {
    ...
    var inInput = $_dq8hw101jlnuehtb.active().exists(function (elem) {
      return contains([
        'input',
        'textarea'
      ], $_exqx3lykjlnuehc5.name(elem));
    });
    var transaction = inInput ? autocompleteHack() : apply;
    transaction(function () {
      $_dq8hw101jlnuehtb.active().each($_dq8hw101jlnuehtb.blur);
      $_dq8hw101jlnuehtb.focus(iBody);
    });
  };
  var $_8lmp4s166jlnuekn2 = { resume: resume };

  var EXTRA_SPACING = 50;
  var data = 'data-' + $_e6ep1c10tjlnuei33.resolve('last-outer-height');
  var setLastHeight = function (cBody, value) {
    $_a7p349zwjlnuehs3.set(cBody, data, value);
  };
  var getLastHeight = function (cBody) {
    return $_gadk3415mjlnuekg9.safeParse(cBody, data);
  };
  ...
  var getBounds$2 = function (cWin) {
    var rects = $_2b6njf15njlnuekgg.getRectangles(cWin);
  ...
  var setup$1 = function (outerWindow, cWin) {
    ...
    var toEditing = function () {
      $_8lmp4s166jlnuekn2.resume(cWin);
    };
    var onResize = $_66gcec15cjlnuekae.bind(Element$$1.fromDom(outerWindow), 'resize', function () {
  ...
  var $_banhxf15ljlnuekf0 = { setup: setup$1 };
  ...
  var getSelectionFromFrame = function (frame) {
    ...
    return optWin.bind($_3h97jy15tjlnuekiy.getExact);
  };
  ...
  var getOrListen = function (editor, doc, name, type) {
    return editor[name].getOrThunk(function () {
      return function (handler) {
        return $_66gcec15cjlnuekae.bind(doc, type, handler);
      };
    });
  };
  ...
  var getActiveApi = function (editor) {
    ...
    var tryFallbackBox = function (win) {
      ...
      return $_3h97jy15tjlnuekiy.getExact(win).filter(isCollapsed).bind(toStartRect);
    };
      ...
      return getDocFromFrame(frame).bind(function (doc) {
        return getWinFromFrame(frame).map(function (win) {
          ...
          var getCursorBox = editor.getCursorBox.getOrThunk(function () {
            return function () {
              return $_3h97jy15tjlnuekiy.get(win).bind(function (sel) {
                return $_3h97jy15tjlnuekiy.getFirstRect(win, sel).orThunk(function () {
          ...
          var setSelection = editor.setSelection.getOrThunk(function () {
            return function (start, soffset, finish, foffset) {
              $_3h97jy15tjlnuekiy.setExact(win, start, soffset, finish, foffset);
            };
          });
          var clearSelection = editor.clearSelection.getOrThunk(function () {
            return function () {
              $_3h97jy15tjlnuekiy.clear(win);
            };
          });
          return {
            body: constant(body),
  ...
  var isAndroid = $_c4pfxvy3jlnueh7s.detect().os.isAndroid();
  var matchColor = function (editorBody) {
    var color = $_av4glr116jlnuei7e.get(editorBody, 'background-color');
    return color !== undefined && color !== '' ? 'background-color:' + color + '!important' : bgFallback;
  };
  var clobberStyles = function (container, editorBody) {
    var gatherSibilings = function (element) {
      var siblings = $_ff9i66119jlnuei8o.siblings(element, '*');
      return siblings;
    };
    var clobber = function (clobberStyle) {
      return function (element) {
        var styles = $_a7p349zwjlnuehs3.get(element, 'style');
        var backup = styles === undefined ? 'no-styles' : styles.trim();
        if (backup === clobberStyle) {
          return;
        } else {
          $_a7p349zwjlnuehs3.set(element, attr, backup);
          $_a7p349zwjlnuehs3.set(element, 'style', clobberStyle);
        }
      };
    };
    var ancestors = $_ff9i66119jlnuei8o.ancestors(container, '*');
  ...
  var restoreStyles = function () {
    var clobberedEls = $_ff9i66119jlnuei8o.all('[' + attr + ']');
    each$1(clobberedEls, function (element) {
      var restore = $_a7p349zwjlnuehs3.get(element, attr);
      if (restore !== 'no-styles') {
        $_a7p349zwjlnuehs3.set(element, 'style', restore);
      } else {
        $_a7p349zwjlnuehs3.remove(element, 'style');
      }
      $_a7p349zwjlnuehs3.remove(element, attr);
  ...
  var $_2sps04168jlnuekok = {
    clobberStyles: clobberStyles,
    restoreStyles: restoreStyles
  };

  var tag = function () {
    var head = $_4cszdu11bjlnuei8x.first('head').getOrDie();
    var nu = function () {
      var meta = Element$$1.fromTag('meta');
      $_a7p349zwjlnuehs3.set(meta, 'name', 'viewport');
      $_5naldxymjlnuehcb.append(head, meta);
      return meta;
    };
    var element = $_4cszdu11bjlnuei8x.first('meta[name="viewport"]').getOrThunk(nu);
    var backup = $_a7p349zwjlnuehs3.get(element, 'content');
    var maximize = function () {
      $_a7p349zwjlnuehs3.set(element, 'content', 'width=device-width, initial-scale=1.0, user-scalable=no, maximum-scale=1.0');
    };
    var restore = function () {
      if (backup !== undefined && backup !== null && backup.length > 0) {
        $_a7p349zwjlnuehs3.set(element, 'content', backup);
      } else {
        $_a7p349zwjlnuehs3.set(element, 'content', 'user-scalable=yes');
      }
    };
    return {
      maximize: maximize,
  ...
  var $_2qdaul169jlnuekp5 = { tag: tag };

  var create$5 = function (platform, mask) {
    var meta = $_2qdaul169jlnuekp5.tag();
    var androidApi = api$2();
    var androidEvents = api$2();
    var enter = function () {
      mask.hide();
      $_1tj8hmzujlnuehrz.add(platform.container, $_e6ep1c10tjlnuei33.resolve('fullscreen-maximized'));
      $_1tj8hmzujlnuehrz.add(platform.container, $_e6ep1c10tjlnuei33.resolve('android-maximized'));
      meta.maximize();
      $_1tj8hmzujlnuehrz.add(platform.body, $_e6ep1c10tjlnuei33.resolve('android-scroll-reload'));
      androidApi.set($_banhxf15ljlnuekf0.setup(platform.win, $_acpb91167jlnueknr.getWin(platform.editor).getOrDie('no')));
      $_acpb91167jlnueknr.getActiveApi(platform.editor).each(function (editorApi) {
        $_2sps04168jlnuekok.clobberStyles(platform.container, editorApi.body());
        androidEvents.set($_ggwuah15hjlnuekcc.initEvents(editorApi, platform.toolstrip, platform.alloy));
      });
    };
    var exit = function () {
      meta.restore();
      mask.show();
      $_1tj8hmzujlnuehrz.remove(platform.container, $_e6ep1c10tjlnuei33.resolve('fullscreen-maximized'));
      $_1tj8hmzujlnuehrz.remove(platform.container, $_e6ep1c10tjlnuei33.resolve('android-maximized'));
      $_2sps04168jlnuekok.restoreStyles();
      $_1tj8hmzujlnuehrz.remove(platform.body, $_e6ep1c10tjlnuei33.resolve('android-scroll-reload'));
      androidEvents.clear();
      androidApi.clear();
    };
    return {
  ...
  var $_7jx90415gjlnuekbz = { create: create$5 };
  ...
  var sketch$10 = function (onView, translate) {
    var memIcon = record(Container.sketch({
      ...
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_e6ep1c10tjlnuei33.resolve('mask-tap-icon-selected'),
          toggleOnExecute: false
        })])
    }));
    ...
    return Container.sketch({
      ...
      components: [Container.sketch({
          ...
          components: [Button.sketch({
              ...
              buttonBehaviours: derive$2([Toggling.config({ toggleClass: $_e6ep1c10tjlnuei33.resolve('mask-tap-icon-selected') })])
            })]
        })]
    });
  };
  var $_eluxka16ajlnuekpr = { sketch: sketch$10 };
  ...
  var MobileSchema = objOf([
    ...
    state$1('win', function (spec) {
      return $_8ewcplynjlnuehce.owner(spec.socket).dom().defaultView;
    }),
  ...
  var produce = function (raw) {
    ...
    $_av4glr116jlnuei7e.set(mobile.toolstrip, 'width', '100%');
    var onTap = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_eluxka16ajlnuekpr.sketch(onTap, mobile.translate));
    ...
    $_5naldxymjlnuehcb.append(mobile.container, mask.element());
    var mode = $_7jx90415gjlnuekbz.create(mobile, maskApi);
    return {
  ...
  var $_2fvpgb15fjlnuekbb = { produce: produce };
  ...
  var dataHorizontal = 'data-' + $_e6ep1c10tjlnuei33.resolve('horizontal-scroll');
  ...
  var markAsHorizontal = function (container) {
    $_a7p349zwjlnuehs3.set(container, dataHorizontal, 'true');
  };
  var hasScroll = function (container) {
    return $_a7p349zwjlnuehs3.get(container, dataHorizontal) === 'true' ? hasHorizontalScroll(container) : hasVerticalScroll(container);
  };
  var exclusive = function (scope, selector) {
    return $_66gcec15cjlnuekae.bind(scope, 'touchmove', function (event) {
      $_4cszdu11bjlnuei8x.closest(event.target(), selector).filter(hasScroll).fold(function () {
        event.raw().preventDefault();
      }, noop);
    });
  };
  var $_waj8x16ijlnueku6 = {
    exclusive: exclusive,
  ...
  function ScrollingToolbar () {
    var makeGroup = function (gSpec) {
      ...
      return {
        ...
        tgroupBehaviours: derive$2([config('adhoc-scrollable-toolbar', gSpec.scrollable === true ? [runOnInit(function (component, simulatedEvent) {
              $_av4glr116jlnuei7e.set(component.element(), 'overflow-x', 'auto');
              $_waj8x16ijlnueku6.markAsHorizontal(component.element());
              $_g7b46t159jlnuek8r.register(component.element());
            })] : [])]),
        components: [Container.sketch({ components: [ToolbarGroup.parts().items({})] })],
        markers: { itemClass: $_e6ep1c10tjlnuei33.resolve('toolbar-group-item') },
        items: gSpec.items
      };
    };
    var toolbar = build$1(Toolbar.sketch({
      ...
      toolbarBehaviours: derive$2([
        Toggling.config({
          toggleClass: $_e6ep1c10tjlnuei33.resolve('context-toolbar'),
          toggleOnExecute: false,
          aria: { mode: 'none' }
        }),
    ...
    var wrapper = build$1(Container.sketch({
      dom: { classes: [$_e6ep1c10tjlnuei33.resolve('toolstrip')] },
      components: [premade$1(toolbar)],
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_e6ep1c10tjlnuei33.resolve('android-selection-context-toolbar'),
          toggleOnExecute: false
        })])
    }));
  ...
  var disableTransitions = function (component, slideConfig) {
    ...
    $_bs4yeq14mjlnuejw9.remove(root, [
      slideConfig.shrinkingClass(),
      slideConfig.growingClass()
    ]);
  };
  var setShrunk = function (component, slideConfig) {
    $_1tj8hmzujlnuehrz.remove(component.element(), slideConfig.openClass());
    $_1tj8hmzujlnuehrz.add(component.element(), slideConfig.closedClass());
    $_av4glr116jlnuei7e.set(component.element(), getDimensionProperty(slideConfig), '0px');
    $_av4glr116jlnuei7e.reflow(component.element());
  };
  ...
  var setGrown = function (component, slideConfig) {
    $_1tj8hmzujlnuehrz.remove(component.element(), slideConfig.closedClass());
    $_1tj8hmzujlnuehrz.add(component.element(), slideConfig.openClass());
    $_av4glr116jlnuei7e.remove(component.element(), getDimensionProperty(slideConfig));
  };
  var doImmediateShrink = function (component, slideConfig, slideState) {
    slideState.setCollapsed();
    $_av4glr116jlnuei7e.set(component.element(), getDimensionProperty(slideConfig), getDimension(slideConfig, component.element()));
    $_av4glr116jlnuei7e.reflow(component.element());
  ...
  var doStartShrink = function (component, slideConfig, slideState) {
    ...
    $_av4glr116jlnuei7e.reflow(component.element());
    var root = getAnimationRoot(component, slideConfig);
    $_1tj8hmzujlnuehrz.add(root, slideConfig.shrinkingClass());
    setShrunk(component, slideConfig);
    slideConfig.onStartShrink()(component);
  };
  var doStartGrow = function (component, slideConfig, slideState) {
    ...
    var root = getAnimationRoot(component, slideConfig);
    $_1tj8hmzujlnuehrz.add(root, slideConfig.growingClass());
    setGrown(component, slideConfig);
    $_av4glr116jlnuei7e.set(component.element(), getDimensionProperty(slideConfig), fullSize);
  ...
  var isGrowing = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_1tj8hmzujlnuehrz.has(root, slideConfig.growingClass()) === true;
  };
  var isShrinking = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_1tj8hmzujlnuehrz.has(root, slideConfig.shrinkingClass()) === true;
  };
  ...
  var events$10 = function (slideConfig, slideState) {
    return derive([run(transitionend(), function (component, simulatedEvent) {
        ...
        if (raw.propertyName === slideConfig.dimension().property()) {
          disableTransitions(component, slideConfig);
          if (slideState.isExpanded()) {
            $_av4glr116jlnuei7e.remove(component.element(), slideConfig.dimension().property());
          }
    ...
    strictOf('dimension', choose$1('property', {
      width: [
        ...
        output$1('getDimension', function (elem) {
          return $_b9pchq130jlnuej3b.get(elem) + 'px';
        })
      ],
      height: [
        output$1('property', 'height'),
        output$1('getDimension', function (elem) {
          return $_2lw4bu115jlnuei7b.get(elem) + 'px';
        })
      ]
    }))
  ];
  ...
  var build$2 = function (refresh, scrollIntoView) {
    var dropup = build$1(Container.sketch({
      dom: {
        tag: 'div',
        classes: [$_e6ep1c10tjlnuei33.resolve('dropup')]
      },
      components: [],
      containerBehaviours: derive$2([
        Replacing.config({}),
        Sliding.config({
          closedClass: $_e6ep1c10tjlnuei33.resolve('dropup-closed'),
          openClass: $_e6ep1c10tjlnuei33.resolve('dropup-open'),
          shrinkingClass: $_e6ep1c10tjlnuei33.resolve('dropup-shrinking'),
          growingClass: $_e6ep1c10tjlnuei33.resolve('dropup-growing'),
        ...
        $_3pq36o10sjlnuei2t.orientation(function (component, data) {
          disappear(noop);
        })
      ])
    }));
  ...
  var isDangerous = function (event$$1) {
    ...
    return keyEv.which === BACKSPACE()[0] && !contains([
      'input',
      'textarea'
    ], $_exqx3lykjlnuehc5.name(event$$1.target()));
  };
  var isFirefox = $_c4pfxvy3jlnueh7s.detect().browser.isFirefox();
  ...
  var bindFocus = function (container, handler) {
    if (isFirefox) {
      return $_66gcec15cjlnuekae.capture(container, 'focus', handler);
    } else {
      return $_66gcec15cjlnuekae.bind(container, 'focusin', handler);
    }
  };
  var bindBlur = function (container, handler) {
    if (isFirefox) {
      return $_66gcec15cjlnuekae.capture(container, 'blur', handler);
    } else {
      return $_66gcec15cjlnuekae.bind(container, 'focusout', handler);
    }
  };
  var setup$2 = function (container, rawSettings) {
    var settings = asRawOrDie('Getting GUI events settings', settingsSchema, rawSettings);
    var pointerEvents = $_c4pfxvy3jlnueh7s.detect().deviceType.isTouch() ? [
      'touchstart',
      'touchmove',
      'touchend',
      'gesturestart'
    ...
    var simpleEvents = map$1(pointerEvents.concat([
      ...
      return $_66gcec15cjlnuekae.bind(container, type, function (event$$1) {
    ...
    var onKeydown = $_66gcec15cjlnuekae.bind(container, 'keydown', function (event$$1) {
    ...
    var defaultView = $_8ewcplynjlnuehce.defaultView(container);
    var onWindowScroll = $_66gcec15cjlnuekae.bind(defaultView, 'scroll', function (event$$1) {
  ...
  var doTriggerHandler = function (lookup, eventType, rawEvent, target, source, logger) {
    ...
    return handler.fold(function () {
      ...
      if (simulatedEvent.isStopped()) {
        ...
        return $_8ewcplynjlnuehce.parent(handlerInfo.element()).fold(function () {
  ...
  var closest$3 = function (target, transform, isRoot) {
    var delegate = $_6b680c103jlnuehtq.closest(target, function (elem) {
  ...
  function Registry () {
    ...
    var failOnDuplicate = function (component, tagId) {
      ...
      if (conflict === component) {
        ...
        throw new Error('The tagId "' + tagId + '" is already used by: ' + element(conflict.element()) + '\nCannot use it for: ' + element(component.element()) + '\n' + 'The conflicting element is' + ($_7usjeyyijlnuehbd.inBody(conflict.element()) ? ' ' : ' not ') + 'already in the DOM');
      }
    };
  ...
  var takeover = function (root) {
    var isAboveRoot = function (el) {
      return $_8ewcplynjlnuehce.parent(root.element()).fold(function () {
        return true;
      }, function (parent) {
        return $_1163wgytjlnuehdl.eq(el, parent);
      });
    };
    ...
    var systemApi = SystemApi({
      ...
      triggerFocus: function (target, originator) {
        read$2(target).fold(function () {
          $_dq8hw101jlnuehtb.focus(target);
        }, function (_alloyId) {
    ...
    var addToWorld = function (component) {
      ...
      if (!$_exqx3lykjlnuehc5.isText(component.element())) {
    ...
    var destroy = function () {
      domEvents.unbind();
      $_fdmzyyyzjlnuehf3.remove(root.element());
    };
  ...
  var READ_ONLY_MODE_CLASS = constant($_e6ep1c10tjlnuei33.resolve('readonly-mode'));
  var EDIT_MODE_CLASS = constant($_e6ep1c10tjlnuei33.resolve('edit-mode'));
  function OuterContainer (spec) {
    var root = build$1(Container.sketch({
      dom: { classes: [$_e6ep1c10tjlnuei33.resolve('outer-container')].concat(spec.classes) },
  ...
  function AndroidRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_e6ep1c10tjlnuei33.resolve('android-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_eq87xu16jjlnuekuq.makeEditSwitch(webapp);
    var socket = $_eq87xu16jjlnuekuq.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_2fvpgb15fjlnuekbb.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        w.exit();
    ...
    var updateMode = function (readOnly) {
      $_eq87xu16jjlnuekuq.updateMode(socket, switchToEdit, readOnly, alloy.root());
    };
    return {
  ...
  var input$1 = function (parent, operation) {
    ...
    $_av4glr116jlnuei7e.setAll(input, {
      opacity: '0',
      position: 'absolute',
      top: '-1000px',
      left: '-1000px'
    });
    $_5naldxymjlnuehcb.append(parent, input);
    $_dq8hw101jlnuehtb.focus(input);
    operation(input);
    $_fdmzyyyzjlnuehf3.remove(input);
  };
  var $_37nov173jlnuel6x = { input: input$1 };
  ...
  var $_8unhlg175jlnuel80 = {
    refreshInput: refreshInput,
    refresh: refresh
  };

  var resume$1 = function (cWin, frame) {
    $_dq8hw101jlnuehtb.active().each(function (active) {
      if (!$_1163wgytjlnuehdl.eq(active, frame)) {
        $_dq8hw101jlnuehtb.blur(active);
      }
    });
    cWin.focus();
    $_dq8hw101jlnuehtb.focus(Element$$1.fromDom(cWin.document.body));
    $_8unhlg175jlnuel80.refresh(cWin);
  };
  var $_f48h3m174jlnuel7h = { resume: resume$1 };

  var stubborn = function (outerBody, cWin, page, frame) {
    var toEditing = function () {
      $_f48h3m174jlnuel7h.resume(cWin, frame);
    };
    var toReading = function () {
      $_37nov173jlnuel6x.input(outerBody, $_dq8hw101jlnuehtb.blur);
    };
    var captureInput = $_66gcec15cjlnuekae.bind(page, 'keydown', function (evt) {
      if (!contains([
          'input',
          'textarea'
        ], $_exqx3lykjlnuehc5.name(evt.target()))) {
        toEditing();
      }
    });
  ...
  var initEvents$1 = function (editorApi, iosApi, toolstrip, socket, dropup) {
    ...
    var reposition = function () {
      var toolbarHeight = $_2lw4bu115jlnuei7b.get(toolstrip);
      iosApi.run(function (api) {
    ...
    var listeners = [
      ...
      $_66gcec15cjlnuekae.bind(editorApi.doc(), 'touchend', function (touchEvent) {
        if ($_1163wgytjlnuehdl.eq(editorApi.html(), touchEvent.target()) || $_1163wgytjlnuehdl.eq(editorApi.body(), touchEvent.target())) {
        }
      }),
      $_66gcec15cjlnuekae.bind(toolstrip, 'transitionend', function (transitionEvent) {
        if (transitionEvent.raw().propertyName === 'height') {
          reposition();
        }
      }),
      $_66gcec15cjlnuekae.capture(toolstrip, 'touchstart', function (touchEvent) {
        saveSelectionFirst();
      ...
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_66gcec15cjlnuekae.bind(editorApi.body(), 'click', function (event) {
        event.kill();
      }),
      $_66gcec15cjlnuekae.bind(toolstrip, 'touchmove', function () {
  ...
  var $_84u3kg176jlnuel87 = { initEvents: initEvents$1 };

  function FakeSelection (win, frame) {
    var doc = win.document;
    var container = Element$$1.fromTag('div');
    $_1tj8hmzujlnuehrz.add(container, $_e6ep1c10tjlnuei33.resolve('unfocused-selections'));
    $_5naldxymjlnuehcb.append(Element$$1.fromDom(doc.documentElement), container);
    var onTouch = $_66gcec15cjlnuekae.bind(container, 'touchstart', function (event) {
      event.prevent();
      $_f48h3m174jlnuel7h.resume(win, frame);
      clear();
    });
    var make = function (rectangle) {
      var span = Element$$1.fromTag('span');
      $_bs4yeq14mjlnuejw9.add(span, [
        $_e6ep1c10tjlnuei33.resolve('layer-editor'),
        $_e6ep1c10tjlnuei33.resolve('unfocused-selection')
      ]);
      $_av4glr116jlnuei7e.setAll(span, {
    ...
    var update = function () {
      clear();
      var rectangles = $_2b6njf15njlnuekgg.getRectangles(win);
      var spans = map$1(rectangles, make);
      $_24dkeiz0jlnuehfb.append(container, spans);
    };
    var clear = function () {
      $_fdmzyyyzjlnuehf3.empty(container);
    };
    var destroy = function () {
      onTouch.unbind();
      $_fdmzyyyzjlnuehf3.remove(container);
    };
    var isActive = function () {
      return $_8ewcplynjlnuehce.children(container).length > 0;
    };
    return {
      update: update,
      isActive: isActive,
  ...
  var $_7inbo517gjlnuelds = { findDevice: findDevice };

  var softKeyboardLimits = function (outerWindow) {
    return $_7inbo517gjlnuelds.findDevice(outerWindow.screen.width, outerWindow.screen.height);
  };
  var accountableKeyboardHeight = function (outerWindow) {
    var portrait = $_2qvsnx15bjlnuek9n.get(outerWindow).isPortrait();
  ...
  var getGreenzone = function (socket, dropup) {
    var outerWindow = $_8ewcplynjlnuehce.owner(socket).dom().defaultView;
    var viewportHeight = $_2lw4bu115jlnuei7b.get(socket) + $_2lw4bu115jlnuei7b.get(dropup);
  ...
  var updatePadding = function (contentBody, socket, dropup) {
    ...
    var deltaHeight = $_2lw4bu115jlnuei7b.get(socket) + $_2lw4bu115jlnuei7b.get(dropup) - greenzoneHeight;
    $_av4glr116jlnuei7e.set(contentBody, 'padding-bottom', deltaHeight + 'px');
  };
  var $_15rmw417fjlnueldd = {
  ...
  var yFixedData = 'data-' + $_e6ep1c10tjlnuei33.resolve('position-y-fixed');
  var yFixedProperty = 'data-' + $_e6ep1c10tjlnuei33.resolve('y-property');
  var yScrollingData = 'data-' + $_e6ep1c10tjlnuei33.resolve('scrolling');
  var windowSizeData = 'data-' + $_e6ep1c10tjlnuei33.resolve('last-window-height');
  var getYFixedData = function (element) {
    return $_gadk3415mjlnuekg9.safeParse(element, yFixedData);
  };
  var getYFixedProperty = function (element) {
    return $_a7p349zwjlnuehs3.get(element, yFixedProperty);
  };
  var getLastWindowSize = function (element) {
    return $_gadk3415mjlnuekg9.safeParse(element, windowSizeData);
  };
  ...
  var classify = function (element) {
    ...
    var classifier = $_a7p349zwjlnuehs3.get(element, yScrollingData) === 'true' ? classifyScrolling : classifyFixed;
    return classifier(element, offsetY);
  };
  var findFixtures = function (container) {
    var candidates = $_ff9i66119jlnuei8o.descendants(container, '[' + yFixedData + ']');
    return map$1(candidates, classify);
  };
  var takeoverToolbar = function (toolbar) {
    var oldToolbarStyle = $_a7p349zwjlnuehs3.get(toolbar, 'style');
    $_av4glr116jlnuei7e.setAll(toolbar, {
      position: 'absolute',
      top: '0px'
    });
    $_a7p349zwjlnuehs3.set(toolbar, yFixedData, '0px');
    $_a7p349zwjlnuehs3.set(toolbar, yFixedProperty, 'top');
    var restore = function () {
      $_a7p349zwjlnuehs3.set(toolbar, 'style', oldToolbarStyle || '');
      $_a7p349zwjlnuehs3.remove(toolbar, yFixedData);
      $_a7p349zwjlnuehs3.remove(toolbar, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverViewport = function (toolbarHeight, height, viewport) {
    var oldViewportStyle = $_a7p349zwjlnuehs3.get(viewport, 'style');
    $_g7b46t159jlnuek8r.register(viewport);
    $_av4glr116jlnuei7e.setAll(viewport, {
      position: 'absolute',
      height: height + 'px',
      width: '100%',
      top: toolbarHeight + 'px'
    });
    $_a7p349zwjlnuehs3.set(viewport, yFixedData, toolbarHeight + 'px');
    $_a7p349zwjlnuehs3.set(viewport, yScrollingData, 'true');
    $_a7p349zwjlnuehs3.set(viewport, yFixedProperty, 'top');
    var restore = function () {
      $_g7b46t159jlnuek8r.deregister(viewport);
      $_a7p349zwjlnuehs3.set(viewport, 'style', oldViewportStyle || '');
      $_a7p349zwjlnuehs3.remove(viewport, yFixedData);
      $_a7p349zwjlnuehs3.remove(viewport, yScrollingData);
      $_a7p349zwjlnuehs3.remove(viewport, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverDropup = function (dropup, toolbarHeight, viewportHeight) {
    var oldDropupStyle = $_a7p349zwjlnuehs3.get(dropup, 'style');
    $_av4glr116jlnuei7e.setAll(dropup, {
      position: 'absolute',
      bottom: '0px'
    });
    $_a7p349zwjlnuehs3.set(dropup, yFixedData, '0px');
    $_a7p349zwjlnuehs3.set(dropup, yFixedProperty, 'bottom');
    var restore = function () {
      $_a7p349zwjlnuehs3.set(dropup, 'style', oldDropupStyle || '');
      $_a7p349zwjlnuehs3.remove(dropup, yFixedData);
      $_a7p349zwjlnuehs3.remove(dropup, yFixedProperty);
    };
    return { restore: restore };
  };
  var deriveViewportHeight = function (viewport, toolbarHeight, dropupHeight) {
    var outerWindow = $_8ewcplynjlnuehce.owner(viewport).dom().defaultView;
    var winH = outerWindow.innerHeight;
    $_a7p349zwjlnuehs3.set(viewport, windowSizeData, winH + 'px');
    return winH - toolbarHeight - dropupHeight;
  };
  var takeover$1 = function (viewport, contentBody, toolbar, dropup) {
    var outerWindow = $_8ewcplynjlnuehce.owner(viewport).dom().defaultView;
    var toolbarSetup = takeoverToolbar(toolbar);
    var toolbarHeight = $_2lw4bu115jlnuei7b.get(toolbar);
    var dropupHeight = $_2lw4bu115jlnuei7b.get(dropup);
    ...
    var refresh = function () {
      if (isActive) {
        var newToolbarHeight = $_2lw4bu115jlnuei7b.get(toolbar);
        var dropupHeight_1 = $_2lw4bu115jlnuei7b.get(dropup);
        var newHeight = deriveViewportHeight(viewport, newToolbarHeight, dropupHeight_1);
        $_a7p349zwjlnuehs3.set(viewport, yFixedData, newToolbarHeight + 'px');
        $_av4glr116jlnuei7e.set(viewport, 'height', newHeight + 'px');
        $_av4glr116jlnuei7e.set(dropup, 'bottom', -(newToolbarHeight + newHeight + dropupHeight_1) + 'px');
        $_15rmw417fjlnueldd.updatePadding(contentBody, viewport, dropup);
      }
    };
    var setViewportOffset = function (newYOffset) {
      var offsetPx = newYOffset + 'px';
      $_a7p349zwjlnuehs3.set(viewport, yFixedData, offsetPx);
      refresh();
    };
    $_15rmw417fjlnueldd.updatePadding(contentBody, viewport, dropup);
    return {
  ...
  var $_2bw66n17ejlnuelcd = {
    findFixtures: findFixtures,
    takeover: takeover$1,
    getYFixedData: getYFixedData
  };

  var animator = $_7lbnha17djlnuelc6.create();
  var ANIMATION_STEP = 15;
  var NUM_TOP_ANIMATION_FRAMES = 10;
  var ANIMATION_RATE = 10;
  var lastScroll = 'data-' + $_e6ep1c10tjlnuei33.resolve('last-scroll-top');
  var getTop = function (element) {
    var raw = $_av4glr116jlnuei7e.getRaw(element, 'top').getOr('0');
  ...
  var moveScrollAndTop = function (element, destination, finalTop) {
    return Future.nu(function (callback) {
      ...
      var update = function (newScroll) {
        ...
        $_av4glr116jlnuei7e.set(element, 'top', getTop(element) + ANIMATION_STEP + 'px');
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_av4glr116jlnuei7e.set(element, 'top', finalTop + 'px');
  ...
  var moveOnlyScroll = function (element, destination) {
    return Future.nu(function (callback) {
      var getCurrent = curry(getScrollTop, element);
      $_a7p349zwjlnuehs3.set(element, lastScroll, getCurrent());
      var update = function (newScroll, abort) {
        var previous = $_gadk3415mjlnuekg9.safeParse(element, lastScroll);
        if (previous !== element.dom().scrollTop) {
          abort(element.dom().scrollTop);
        } else {
          element.dom().scrollTop = newScroll;
          $_a7p349zwjlnuehs3.set(element, lastScroll, newScroll);
        }
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_a7p349zwjlnuehs3.set(element, lastScroll, destination);
        callback(destination);
      };
  ...
  var moveOnlyTop = function (element, destination) {
    return Future.nu(function (callback) {
      ...
      var update = function (newTop) {
        $_av4glr116jlnuei7e.set(element, 'top', newTop + 'px');
      };
      var finish = function () {
        update(destination);
        callback(destination);
  ...
  var updateTop = function (element, amount) {
    var newTop = amount + $_2bw66n17ejlnuelcd.getYFixedData(element) + 'px';
    $_av4glr116jlnuei7e.set(element, 'top', newTop);
  };
  var moveWindowScroll = function (toolbar, viewport, destY) {
    var outerWindow = $_8ewcplynjlnuehce.owner(toolbar).dom().defaultView;
    return Future.nu(function (callback) {
  ...
  var scrollIntoView = function (cWin, socket, dropup, top, bottom) {
    var greenzone = $_15rmw417fjlnueldd.getGreenzone(socket, dropup);
    var refreshCursor = curry($_8unhlg175jlnuel80.refresh, cWin);
    if (top > greenzone || bottom > greenzone) {
      $_elc16u179jlnuelbc.moveOnlyScroll(socket, socket.dom().scrollTop - greenzone + bottom).get(refreshCursor);
    } else if (top < 0) {
      $_elc16u179jlnuelbc.moveOnlyScroll(socket, socket.dom().scrollTop + top).get(refreshCursor);
    } else {
    }
  };
  var $_aab1ur17ijlnuelef = { scrollIntoView: scrollIntoView };
  ...
  var updateFixed = function (element, property, winY, offsetY) {
    ...
    $_av4glr116jlnuei7e.set(element, property, destination + 'px');
    return Future.pure(offsetY);
  };
  var updateScrollingFixed = function (element, winY, offsetY) {
    var destTop = winY + offsetY;
    var oldProp = $_av4glr116jlnuei7e.getRaw(element, 'top').getOr(offsetY);
    var delta = destTop - parseInt(oldProp, 10);
    var destScroll = element.dom().scrollTop + delta;
    return $_elc16u179jlnuelbc.moveScrollAndTop(element, destScroll, destTop);
  };
  ...
  var register$2 = function (toolstrip, socket, container, outerWindow, structure, cWin) {
    ...
    var scrollThrottle = last$3(function () {
      scroller.idle(function () {
        $_2b560b17jjlnuelem.updatePositions(container, outerWindow.pageYOffset).get(function () {
    ...
    var onScroll = $_66gcec15cjlnuekae.bind(Element$$1.fromDom(outerWindow), 'scroll', function () {
      if (outerWindow.pageYOffset < 0) {
        return;
      }
      scrollThrottle.throttle();
    });
    $_2b560b17jjlnuelem.updatePositions(container, outerWindow.pageYOffset).get(identity);
  ...
  var setup$3 = function (bag) {
    ...
    var structure = $_2bw66n17ejlnuelcd.takeover(socket, ceBody, toolstrip, dropup);
    var keyboardModel = keyboardType(bag.outerBody(), cWin, $_7usjeyyijlnuehbd.body(), contentElement, toolstrip, toolbar);
    var toEditing = function () {
    ...
    var onOrientation = $_2qvsnx15bjlnuek9n.onChange(outerWindow, {
      onChange: noop,
    ...
    var scrollIntoView = function (top, bottom) {
      $_aab1ur17ijlnuelef.scrollIntoView(cWin, socket, dropup, top, bottom);
    };
    var syncHeight = function () {
      $_av4glr116jlnuei7e.set(contentElement, 'height', contentElement.dom().contentWindow.document.body.scrollHeight + 'px');
    };
    var setViewportOffset = function (newYOffset) {
      structure.setViewportOffset(newYOffset);
      $_elc16u179jlnuelbc.moveOnlyTop(socket, newYOffset).get(identity);
    };
    var destroy = function () {
      structure.restore();
      ...
      $_37nov173jlnuel6x.input($_7usjeyyijlnuehbd.body(), $_dq8hw101jlnuehtb.blur);
    };
    return {
      toEditing: toEditing,
      toReading: toReading,
  ...
  var $_8rv7g9177jlnuel8v = { setup: setup$3 };
  ...
  var create$8 = function (platform, mask) {
    ...
    var enter = function () {
      ...
      $_acpb91167jlnueknr.getActiveApi(platform.editor).each(function (editorApi) {
        priorState.set({
          socketHeight: $_av4glr116jlnuei7e.getRaw(platform.socket, 'height'),
          iframeHeight: $_av4glr116jlnuei7e.getRaw(editorApi.frame(), 'height'),
          outerScroll: document.body.scrollTop
        });
        scrollEvents.set({ exclusives: $_waj8x16ijlnueku6.exclusive(doc, '.' + $_g7b46t159jlnuek8r.scrollable()) });
        $_1tj8hmzujlnuehrz.add(platform.container, $_e6ep1c10tjlnuei33.resolve('fullscreen-maximized'));
        $_2sps04168jlnuekok.clobberStyles(platform.container, editorApi.body());
        meta.maximize();
        $_av4glr116jlnuei7e.set(platform.socket, 'overflow', 'scroll');
        $_av4glr116jlnuei7e.set(platform.socket, '-webkit-overflow-scrolling', 'touch');
        $_dq8hw101jlnuehtb.focus(editorApi.body());
        ...
        iosApi.set($_8rv7g9177jlnuel8v.setup(setupBag({
          cWin: editorApi.win(),
          ...
          keyboardType: $_eiqv1v172jlnuel6a.stubborn,
        ...
        iosEvents.set($_84u3kg176jlnuel87.initEvents(editorApi, iosApi, platform.toolstrip, platform.socket, platform.dropup));
      });
    };
    var exit = function () {
      meta.restore();
      ...
      priorState.on(function (s) {
        s.socketHeight.each(function (h) {
          $_av4glr116jlnuei7e.set(platform.socket, 'height', h);
        });
        s.iframeHeight.each(function (h) {
          $_av4glr116jlnuei7e.set(platform.editor.getFrame(), 'height', h);
        });
      ...
      $_1tj8hmzujlnuehrz.remove(platform.container, $_e6ep1c10tjlnuei33.resolve('fullscreen-maximized'));
      $_2sps04168jlnuekok.restoreStyles();
      $_g7b46t159jlnuek8r.deregister(platform.toolbar);
      $_av4glr116jlnuei7e.remove(platform.socket, 'overflow');
      $_av4glr116jlnuei7e.remove(platform.socket, '-webkit-overflow-scrolling');
      $_dq8hw101jlnuehtb.blur(platform.editor.getFrame());
      $_acpb91167jlnueknr.getActiveApi(platform.editor).each(function (editorApi) {
  ...
  var $_1fonp171jlnuel5e = { create: create$8 };

  var produce$1 = function (raw) {
    var mobile = asRawOrDie('Getting IosWebapp schema', MobileSchema, raw);
    $_av4glr116jlnuei7e.set(mobile.toolstrip, 'width', '100%');
    $_av4glr116jlnuei7e.set(mobile.container, 'position', 'relative');
    var onView = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_eluxka16ajlnuekpr.sketch(onView, mobile.translate));
    mobile.alloy.add(mask);
    var maskApi = {
      show: function () {
        mobile.alloy.add(mask);
    ...
    var mode = $_1fonp171jlnuel5e.create(mobile, maskApi);
    return {
      setReadOnly: mobile.setReadOnly,
  ...
  var $_8cpplp170jlnuel4w = { produce: produce$1 };

  function IosRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_e6ep1c10tjlnuei33.resolve('ios-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_eq87xu16jjlnuekuq.makeEditSwitch(webapp);
    var socket = $_eq87xu16jjlnuekuq.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_8cpplp170jlnuel4w.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        Replacing.remove(socket, switchToEdit);
  ...
  var $_9smiq317mjlnuelfb = { derive: derive$4 };
  ...
  var fireChange$1 = function (realm, command, state) {
    realm.system().broadcastOn([$_djvm81109jlnuehv2.formatChanged()], {
      command: command,
      state: state
    });
  };
  ...
  var $_e6hupn17pjlnuelfu = { fireSkinLoaded: fireSkinLoaded };

  var READING = constant('toReading');
  var EDITING = constant('toEditing');
  global$1.add('mobile', function (editor) {
    var renderUI = function (args) {
      var cssUrls = $_9smiq317mjlnuelfb.derive(editor);
      if (isSkinDisabled(editor) === false) {
        editor.contentCSS.push(cssUrls.content);
        global.DOM.styleSheetLoader.load(cssUrls.ui, $_e6hupn17pjlnuelfu.fireSkinLoaded(editor));
      } else {
        $_e6hupn17pjlnuelfu.fireSkinLoaded(editor)();
      }
      var doScrollIntoView = function () {
        editor.fire('scrollIntoView');
      };
      var wrapper = Element$$1.fromTag('div');
      var realm = $_c4pfxvy3jlnueh7s.detect().os.isAndroid() ? AndroidRealm(doScrollIntoView) : IosRealm(doScrollIntoView);
      var original = Element$$1.fromDom(args.targetNode);
      $_5naldxymjlnuehcb.after(original, wrapper);
      attachSystem(wrapper, realm.system());
      var findFocusIn = function (elem) {
        return $_dq8hw101jlnuehtb.search(elem).bind(function (focused) {
          return realm.system().getByDom(focused).toOption();
        });
      };
      var outerWindow = args.targetNode.ownerDocument.defaultView;
      var orientation = $_2qvsnx15bjlnuek9n.onChange(outerWindow, {
        onChange: function () {
          var alloy = realm.system();
          alloy.broadcastOn([$_djvm81109jlnuehv2.orientationChanged()], { width: $_2qvsnx15bjlnuek9n.getActualWidth(outerWindow) });
        },
        onReady: noop
      });
      ...
      editor.on('init', function () {
        realm.init({
          editor: {
            ...
            onTouchContent: function () {
              var toolbar = Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_e6ep1c10tjlnuei33.resolve('toolbar')));
            ...
            onTapContent: function (evt) {
              ...
              if ($_exqx3lykjlnuehc5.name(target) === 'img') {
                editor.selection.select(target.dom());
                evt.kill();
              } else if ($_exqx3lykjlnuehc5.name(target) === 'a') {
                var component = realm.system().getByDom(Element$$1.fromDom(editor.editorContainer));
                component.each(function (container) {
                  if (Swapping.isAlpha(container)) {
                    $_h8tr1107jlnuehus.openLink(target.dom());
                  }
                });
              }
            }
          ...
          toolstrip: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_e6ep1c10tjlnuei33.resolve('toolstrip'))),
          toolbar: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_e6ep1c10tjlnuei33.resolve('toolbar'))),
          dropup: realm.dropup(),
          alloy: realm.system(),
          translate: noop,
        ...
        var hideDropup = function () {
          realm.dropup().disappear(function () {
            realm.system().broadcastOn([$_djvm81109jlnuehv2.dropupDismissed()], {});
          });
        };
        var backToMaskGroup = {
          label: 'The first group',
          scrollable: false,
          items: [$_d2s15g10ujlnuei38.forToolbar('back', function () {
              editor.selection.collapse();
              realm.exit();
            }, {})]
        };
        var backToReadOnlyGroup = {
          ...
          scrollable: false,
          items: [$_d2s15g10ujlnuei38.forToolbar('readonly-back', function () {
        ...
        var features = $_7ou12710ajlnuehva.setup(realm, editor);
        var items = $_7ou12710ajlnuehva.detect(editor.settings, features);
        var actionGroup = {
        ...
        $_7bdwl417ojlnuelfi.init(realm, editor);
      });
      return {
