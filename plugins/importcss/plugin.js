...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_bv9kfvfcjlnueb97.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_bv9kfvfcjlnueb97.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_bv9kfvfcjlnueb97.getSelectorConverter(editor)) {
      selectorConverter = $_bv9kfvfcjlnueb97.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_bv9kfvfcjlnueb97.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_bv9kfvfcjlnueb97.getCssGroups(editor));
      ...
      if (!$_bv9kfvfcjlnueb97.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_bv9kfvfcjlnueb97.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_75ia8kf7jlnueb8x.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_a6i8i4f6jlnueb8t = { get: get };

  global.add('importcss', function (editor) {
    $_75ia8kf7jlnueb8x.setup(editor);
    return $_a6i8i4f6jlnueb8t.get(editor);
  });
  function Plugin () {
  }
