...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_2znr56jfjlnueby7.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_2znr56jfjlnueby7.getPreviewDialogWidth(editor);
    var dialogHeight = $_2znr56jfjlnueby7.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_1r6fejgjlnuebya.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_9duhfujdjlnueby4 = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_9duhfujdjlnueby4.open(editor);
    });
  };
  var $_g48lx5jcjlnueby2 = { register: register };
  ...
  var $_2k18bhjijlnuebyg = { register: register$1 };

  global.add('preview', function (editor) {
    $_g48lx5jcjlnueby2.register(editor);
    $_2k18bhjijlnuebyg.register(editor);
  });
  function Plugin () {
  }
