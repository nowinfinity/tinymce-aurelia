...
var spellchecker = (function () {
  ...
  var $_8jintxk8jlnuec30 = { hasProPlugin: hasProPlugin };
  ...
  var defaultSpellcheckCallback = function (editor, pluginUrl, currentLanguageState) {
    return function (method, text, doneCallback, errorCallback) {
      ...
      global$3.send({
        url: new global$2(pluginUrl).toAbsolute($_7jxen3kbjlnuec3l.getRpcUrl(editor)),
        type: 'post',
        ...
        error: function () {
          var message = editor.translate('The spelling service was not found: (') + $_7jxen3kbjlnuec3l.getRpcUrl(editor) + editor.translate(')');
          errorCallback(message);
        }
      });
    };
  ...
  var sendRpcCall = function (editor, pluginUrl, currentLanguageState, name, data, successCallback, errorCallback) {
    var userSpellcheckCallback = $_7jxen3kbjlnuec3l.getSpellcheckerCallback(editor);
  ...
  var finish = function (editor, startedState, textMatcherState) {
    ...
    if (startedState.get()) {
      ...
      $_cx7lmzkgjlnuec3y.fireSpellcheckEnd(editor);
      return true;
    }
  };
  ...
  var markErrors = function (editor, startedState, textMatcherState, lastSuggestionsState, data) {
    ...
    getTextMatcher(editor, textMatcherState).find($_7jxen3kbjlnuec3l.getSpellcheckerWordcharPattern(editor)).filter(function (match) {
    ...
    $_cx7lmzkgjlnuec3y.fireSpellcheckStart(editor);
  };
  var $_dry33nkcjlnuec3s = {
  ...
  var get = function (editor, startedState, lastSuggestionsState, textMatcherState, currentLanguageState, url) {
    ...
    var getWordCharPattern = function () {
      return $_7jxen3kbjlnuec3l.getSpellcheckerWordcharPattern(editor);
    };
    var markErrors = function (data) {
      $_dry33nkcjlnuec3s.markErrors(editor, startedState, textMatcherState, lastSuggestionsState, data);
    };
  ...
  var $_2e90vvkajlnuec3i = { get: get };

  var register = function (editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState) {
    editor.addCommand('mceSpellCheck', function () {
      $_dry33nkcjlnuec3s.spellcheck(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
    });
  };
  var $_cqkc6gkijlnuec4c = { register: register };
  ...
  var getItems = function (editor) {
    return global$1.map($_7jxen3kbjlnuec3l.getLanguages(editor).split(','), function (langPair) {
  ...
  var $_7e3nyukjjlnuec4f = { register: register$1 };
  ...
  var showSuggestions = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState, word, spans) {
    ...
    global$1.each(suggestions, function (suggestion) {
      items.push({
        ...
        onclick: function () {
          ...
          $_dry33nkcjlnuec3s.checkIfFinished(editor, startedState, textMatcherState);
        }
      });
    });
    items.push({ text: '-' });
    ...
    if (hasDictionarySupport) {
      items.push({
        ...
        onclick: function () {
          $_dry33nkcjlnuec3s.addToDictionary(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, word, spans);
        }
      });
    }
    items.push.apply(items, [
      {
        text: 'Ignore',
        onclick: function () {
          $_dry33nkcjlnuec3s.ignoreWord(editor, startedState, textMatcherState, word, spans);
        }
      },
      {
        text: 'Ignore all',
        onclick: function () {
          $_dry33nkcjlnuec3s.ignoreWord(editor, startedState, textMatcherState, word, spans, true);
        }
      }
    ]);
  ...
  var setup = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState) {
    editor.on('click', function (e) {
      ...
      if (target.className === 'mce-spellchecker-word') {
        e.preventDefault();
        var spans = $_dry33nkcjlnuec3s.findSpansByIndex(editor, $_dry33nkcjlnuec3s.getElmIndex(target));
        if (spans.length > 0) {
          var rng = editor.dom.createRng();
  ...
  var $_6ah8rfkkjlnuec4i = { setup: setup };

  global.add('spellchecker', function (editor, pluginUrl) {
    if ($_8jintxk8jlnuec30.hasProPlugin(editor) === false) {
      var startedState = Cell(false);
      var currentLanguageState = Cell($_7jxen3kbjlnuec3l.getLanguage(editor));
      var textMatcherState = Cell(null);
      var lastSuggestionsState = Cell(null);
      $_7e3nyukjjlnuec4f.register(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState);
      $_6ah8rfkkjlnuec4i.setup(editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState);
      $_cqkc6gkijlnuec4c.register(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
      return $_2e90vvkajlnuec3i.get(editor, startedState, lastSuggestionsState, textMatcherState, currentLanguageState, pluginUrl);
    }
  });
  function Plugin () {
  }
