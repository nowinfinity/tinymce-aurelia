...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_c9lnr0agjlnuea0i.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_g876kdabjlnue9yx.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_asqcusadjlnue9z0.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_fafay7ahjlnuea0l = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_89woksaajlnue9yu = {
    open: function (editor) {
      var minWidth = $_g876kdabjlnue9yx.getDialogMinWidth(editor);
      var minHeight = $_g876kdabjlnue9yx.getDialogMinHeight(editor);
      var currentLanguage = $_fafay7ahjlnuea0l.getCurrentLanguage(editor);
      var currentLanguages = $_fafay7ahjlnuea0l.getLanguages(editor);
      var currentCode = $_asqcusadjlnue9z0.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_asqcusadjlnue9z0.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_c9lnr0agjlnuea0i.isCodeSample(node)) {
        $_89woksaajlnue9yu.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_9k2jota9jlnue9yr = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_c9lnr0agjlnuea0i.trimArg($_c9lnr0agjlnuea0i.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_c9lnr0agjlnuea0i.trimArg($_c9lnr0agjlnuea0i.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_bg2qrlaijlnuea0n = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_g876kdabjlnue9yx.getContentCss(editor);
  ...
  var $_e9fn7hajjlnuea0q = { loadCss: loadCss };
  ...
  var $_2wg7e3akjlnuea0s = { register: register$1 };

  var addedInlineCss = Cell(false);
  global.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_bg2qrlaijlnuea0n.setup(editor);
    $_2wg7e3akjlnuea0s.register(editor);
    $_9k2jota9jlnue9yr.register(editor);
    editor.on('init', function () {
      $_e9fn7hajjlnuea0q.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_c9lnr0agjlnuea0i.isCodeSample(ev.target)) {
        $_89woksaajlnue9yu.open(editor);
      }
    });
  });
