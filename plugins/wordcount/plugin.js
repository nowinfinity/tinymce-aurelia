...
var wordcount = (function () {
  ...
  var $_6agl8htjjlnuefzg = {
    each: each,
    map: map
  };

  var SETS$1 = $_5jxrf8thjlnuefz9.SETS;
  var OTHER = $_5jxrf8thjlnuefz9.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_6agl8htjjlnuefzg.map(string.split(''), memoized);
  };
  var $_1ek7gdtijlnuefzd = { classify: classify };

  var ci = $_5jxrf8thjlnuefz9.characterIndices;
  ...
  var $_55lxpstkjlnuefzi = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_5jxrf8thjlnuefz9.EMPTY_STRING;
  var WHITESPACE$1 = $_5jxrf8thjlnuefz9.WHITESPACE;
  var PUNCTUATION$1 = $_5jxrf8thjlnuefz9.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_1ek7gdtijlnuefzd.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_55lxpstkjlnuefzi.isWordBoundary(map, i)) {
  ...
  var $_eap9uqtgjlnuefz5 = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_eap9uqtgjlnuefz5.getWords(getTextContent(editor)).length;
  };
  var $_7wt8zbtfjlnuefz3 = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_7wt8zbtfjlnuefz3.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_g1bfc0tejlnuefz1 = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_7wt8zbtfjlnuefz3.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_5uzr78tljlnuefzn = { setup: setup };

  global.add('wordcount', function (editor) {
    $_5uzr78tljlnuefzn.setup(editor);
    return $_g1bfc0tejlnuefz1.get(editor);
  });
  function Plugin () {
  }
